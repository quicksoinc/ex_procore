...
defmodule ProcoreV1API.Connection do
  @moduledoc """
  Handle Tesla connections for ProcoreV1API.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, ProcoreV1API.Connection,
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:ex_procore, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - ProcoreV1API 1.0 - elixir"
        )
      )
