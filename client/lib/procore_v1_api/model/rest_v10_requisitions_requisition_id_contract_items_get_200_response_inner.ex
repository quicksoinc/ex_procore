...
defmodule ProcoreV1API.Model.RestV10RequisitionsRequisitionIdContractItemsGet200ResponseInner do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10RequisitionsRequisitionIdContractItemsGet200ResponseInner do
