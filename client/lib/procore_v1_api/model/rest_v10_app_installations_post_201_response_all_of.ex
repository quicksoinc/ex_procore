...
defmodule ProcoreV1API.Model.RestV10AppInstallationsPost201ResponseAllOf do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10AppInstallationsPost201ResponseAllOf do
