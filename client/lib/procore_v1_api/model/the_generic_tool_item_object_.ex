...
defmodule ProcoreV1API.Model.TheGenericToolItemObject do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :"custom_field_%{custom_field_definition_id}" => ProcoreV1API.Model.TheGenericToolItemObjectCustomFieldCustomFieldDefinitionId.t | nil
  }
end

defimpl Poison.Decoder, for: ProcoreV1API.Model.TheGenericToolItemObject do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:"custom_field_%{custom_field_definition_id}", :struct, ProcoreV1API.Model.TheGenericToolItemObjectCustomFieldCustomFieldDefinitionId, options)
  end
end
