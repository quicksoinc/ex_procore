...
defmodule ProcoreV1API.Model.RestV10PrimeContractsGet200ResponseInnerContractorAllOf do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10PrimeContractsGet200ResponseInnerContractorAllOf do
