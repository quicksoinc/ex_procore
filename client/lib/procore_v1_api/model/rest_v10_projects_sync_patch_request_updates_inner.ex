...
defmodule ProcoreV1API.Model.RestV10ProjectsSyncPatchRequestUpdatesInner do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10ProjectsSyncPatchRequestUpdatesInner do
