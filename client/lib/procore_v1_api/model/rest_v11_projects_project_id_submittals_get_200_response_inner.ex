...
defmodule ProcoreV1API.Model.RestV11ProjectsProjectIdSubmittalsGet200ResponseInner do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :id => integer() | nil,
    :approvers => [ProcoreV1API.Model.RestV11ProjectsProjectIdSubmittalsGet200ResponseInnerApproversInner.t] | nil,
    ...
    :ball_in_court => [ProcoreV1API.Model.RestV11ProjectsProjectIdSubmittalsGet200ResponseInnerBallInCourtInner.t] | nil,
    ...
    :last_distributed_submittal => ProcoreV1API.Model.RestV11ProjectsProjectIdSubmittalsGet200ResponseInnerLastDistributedSubmittal.t | nil,
    :linked_drawing_ids => [integer()] | nil,
    :location_id => integer() | nil,
    :number => String.t | nil,
    :private => boolean() | nil,
    :received_date => Date.t | nil,
    :received_from => ProcoreV1API.Model.RestV10ProjectsProjectIdTimesheetsPotentialTimesheetCreatorsGet200ResponseInner.t | nil,
    ...
    :submittal_manager => ProcoreV1API.Model.RestV10ProjectsProjectIdTimesheetsPotentialTimesheetCreatorsGet200ResponseInner.t | nil,
    :submittal_package => ProcoreV1API.Model.RestV11ProjectsProjectIdSubmittalsGet200ResponseInnerSubmittalPackage.t | nil,
    :title => String.t | nil,
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV11ProjectsProjectIdSubmittalsGet200ResponseInner do
  import ProcoreV1API.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:approvers, :list, ProcoreV1API.Model.RestV11ProjectsProjectIdSubmittalsGet200ResponseInnerApproversInner, options)
    ...
    |> deserialize(:ball_in_court, :list, ProcoreV1API.Model.RestV11ProjectsProjectIdSubmittalsGet200ResponseInnerBallInCourtInner, options)
    ...
    |> deserialize(:last_distributed_submittal, :struct, ProcoreV1API.Model.RestV11ProjectsProjectIdSubmittalsGet200ResponseInnerLastDistributedSubmittal, options)
    |> deserialize(:received_date, :date, nil, options)
    |> deserialize(:received_from, :struct, ProcoreV1API.Model.RestV10ProjectsProjectIdTimesheetsPotentialTimesheetCreatorsGet200ResponseInner, options)
    ...
    |> deserialize(:submittal_manager, :struct, ProcoreV1API.Model.RestV10ProjectsProjectIdTimesheetsPotentialTimesheetCreatorsGet200ResponseInner, options)
    |> deserialize(:submittal_package, :struct, ProcoreV1API.Model.RestV11ProjectsProjectIdSubmittalsGet200ResponseInnerSubmittalPackage, options)
