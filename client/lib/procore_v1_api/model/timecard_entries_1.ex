...
defmodule ProcoreV1API.Model.TimecardEntries1 do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :updates => [ProcoreV1API.Model.TimecardEntries1UpdatesInner.t],
    :user_id => integer() | nil,
    :work_classification_id => integer() | nil
  }
end

defimpl Poison.Decoder, for: ProcoreV1API.Model.TimecardEntries1 do
  import ProcoreV1API.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:date, :date, nil, options)
    |> deserialize(:updates, :list, ProcoreV1API.Model.TimecardEntries1UpdatesInner, options)
  end
end
