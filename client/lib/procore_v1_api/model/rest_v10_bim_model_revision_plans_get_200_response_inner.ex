...
defmodule ProcoreV1API.Model.RestV10BimModelRevisionPlansGet200ResponseInner do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10BimModelRevisionPlansGet200ResponseInner do
