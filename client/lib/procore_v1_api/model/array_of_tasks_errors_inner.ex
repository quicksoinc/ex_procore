...
defmodule ProcoreV1API.Model.ArrayOfTasksErrorsInner do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :updated_by => ProcoreV1API.Model.RestV10ProjectsProjectIdWorkLogsGet200ResponseInnerCreatedBy.t | nil,
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.ArrayOfTasksErrorsInner do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:updated_by, :struct, ProcoreV1API.Model.RestV10ProjectsProjectIdWorkLogsGet200ResponseInnerCreatedBy, options)
