...
defmodule ProcoreV1API.Model.RestV10ProjectsProjectIdIncidentsAlertsGet200ResponseInnerInjury do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :affected_person => ProcoreV1API.Model.RestV10ProjectsProjectIdIncidentsAlertsGet200ResponseInnerInjuryAffectedPerson.t | nil,
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10ProjectsProjectIdIncidentsAlertsGet200ResponseInnerInjury do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:affected_person, :struct, ProcoreV1API.Model.RestV10ProjectsProjectIdIncidentsAlertsGet200ResponseInnerInjuryAffectedPerson, options)
