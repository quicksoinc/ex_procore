...
defmodule ProcoreV1API.Model.IncidentEnvironmentalUpdateParameters do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.IncidentEnvironmentalUpdateParameters do
