...
defmodule ProcoreV1API.Model.RestV10PrimeContractsGet200ResponseInnerContractor do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10PrimeContractsGet200ResponseInnerContractor do
