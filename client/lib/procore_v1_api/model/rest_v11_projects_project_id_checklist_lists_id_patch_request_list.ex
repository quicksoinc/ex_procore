...
defmodule ProcoreV1API.Model.RestV11ProjectsProjectIdChecklistListsIdPatchRequestList do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV11ProjectsProjectIdChecklistListsIdPatchRequestList do
