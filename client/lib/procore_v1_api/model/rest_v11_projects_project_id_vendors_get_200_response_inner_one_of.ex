...
defmodule ProcoreV1API.Model.RestV11ProjectsProjectIdVendorsGet200ResponseInnerOneOf do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :attachments => [ProcoreV1API.Model.NormalViewAttachmentsInner.t] | nil,
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV11ProjectsProjectIdVendorsGet200ResponseInnerOneOf do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:attachments, :list, ProcoreV1API.Model.NormalViewAttachmentsInner, options)
