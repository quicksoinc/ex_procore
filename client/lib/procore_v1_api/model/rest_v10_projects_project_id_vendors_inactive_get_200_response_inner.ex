...
defmodule ProcoreV1API.Model.RestV10ProjectsProjectIdVendorsInactiveGet200ResponseInner do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10ProjectsProjectIdVendorsInactiveGet200ResponseInner do
