...
defmodule ProcoreV1API.Model.ArrayOfChangeOrderRequestsEntitiesInner do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.ArrayOfChangeOrderRequestsEntitiesInner do
