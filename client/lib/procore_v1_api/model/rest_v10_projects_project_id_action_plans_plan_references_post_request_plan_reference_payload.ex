...
defmodule ProcoreV1API.Model.RestV10ProjectsProjectIdActionPlansPlanReferencesPostRequestPlanReferencePayload do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10ProjectsProjectIdActionPlansPlanReferencesPostRequestPlanReferencePayload do
