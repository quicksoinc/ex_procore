...
defmodule ProcoreV1API.Model.ChecklistSectionItem1AttachmentHistoriesInner do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.ChecklistSectionItem1AttachmentHistoriesInner do
