...
defmodule ProcoreV1API.Model.NestedBimViewFolderBatchCreateResponseErrorsInner do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.NestedBimViewFolderBatchCreateResponseErrorsInner do
