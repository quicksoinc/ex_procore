...
defmodule ProcoreV1API.Model.TimecardEntriesTimecardEntriesInner do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.TimecardEntriesTimecardEntriesInner do
