...
defmodule ProcoreV1API.Model.RestV10WorkOrderContractsPost201ResponseChangeOrderPackagesInner do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10WorkOrderContractsPost201ResponseChangeOrderPackagesInner do
