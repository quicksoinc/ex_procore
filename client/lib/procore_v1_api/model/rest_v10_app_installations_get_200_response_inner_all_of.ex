...
defmodule ProcoreV1API.Model.RestV10AppInstallationsGet200ResponseInnerAllOf do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10AppInstallationsGet200ResponseInnerAllOf do
