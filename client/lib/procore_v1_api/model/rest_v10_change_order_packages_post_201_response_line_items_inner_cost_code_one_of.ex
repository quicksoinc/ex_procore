...
defmodule ProcoreV1API.Model.RestV10ChangeOrderPackagesPost201ResponseLineItemsInnerCostCodeOneOf do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10ChangeOrderPackagesPost201ResponseLineItemsInnerCostCodeOneOf do
