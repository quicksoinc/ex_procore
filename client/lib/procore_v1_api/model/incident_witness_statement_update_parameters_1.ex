...
defmodule ProcoreV1API.Model.IncidentWitnessStatementUpdateParameters1 do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.IncidentWitnessStatementUpdateParameters1 do
