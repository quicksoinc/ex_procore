...
defmodule ProcoreV1API.Model.RestV10PotentialChangeOrdersGet200ResponseInner do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10PotentialChangeOrdersGet200ResponseInner do
