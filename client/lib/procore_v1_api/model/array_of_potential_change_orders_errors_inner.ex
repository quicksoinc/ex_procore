...
defmodule ProcoreV1API.Model.ArrayOfPotentialChangeOrdersErrorsInner do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.ArrayOfPotentialChangeOrdersErrorsInner do
