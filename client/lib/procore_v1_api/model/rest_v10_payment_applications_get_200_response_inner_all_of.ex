...
defmodule ProcoreV1API.Model.RestV10PaymentApplicationsGet200ResponseInnerAllOf do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10PaymentApplicationsGet200ResponseInnerAllOf do
