...
defmodule ProcoreV1API.Model.RestV10PaymentApplicationsIdGet200ResponseAllOfG703Inner do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10PaymentApplicationsIdGet200ResponseAllOfG703Inner do
