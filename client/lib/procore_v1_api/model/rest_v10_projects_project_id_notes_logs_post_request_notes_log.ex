...
defmodule ProcoreV1API.Model.RestV10ProjectsProjectIdNotesLogsPostRequestNotesLog do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10ProjectsProjectIdNotesLogsPostRequestNotesLog do
