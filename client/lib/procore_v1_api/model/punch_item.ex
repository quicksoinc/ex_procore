...
defmodule ProcoreV1API.Model.PunchItem do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :assignments => [ProcoreV1API.Model.PunchItemAssignmentsInner.t] | nil,
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.PunchItem do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:assignments, :list, ProcoreV1API.Model.PunchItemAssignmentsInner, options)
