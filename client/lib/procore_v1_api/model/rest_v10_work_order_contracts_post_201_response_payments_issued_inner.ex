...
defmodule ProcoreV1API.Model.RestV10WorkOrderContractsPost201ResponsePaymentsIssuedInner do
  @moduledoc """
  Contract Payment
  """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10WorkOrderContractsPost201ResponsePaymentsIssuedInner do
