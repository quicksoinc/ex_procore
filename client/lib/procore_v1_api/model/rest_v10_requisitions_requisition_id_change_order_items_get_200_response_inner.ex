...
defmodule ProcoreV1API.Model.RestV10RequisitionsRequisitionIdChangeOrderItemsGet200ResponseInner do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10RequisitionsRequisitionIdChangeOrderItemsGet200ResponseInner do
