...
defmodule ProcoreV1API.Model.RestV10CompaniesCompanyIdPdfTemplateConfigsGet200ResponseInnerPdfConfigOptions do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10CompaniesCompanyIdPdfTemplateConfigsGet200ResponseInnerPdfConfigOptions do
