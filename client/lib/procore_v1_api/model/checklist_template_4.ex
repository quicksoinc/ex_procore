...
defmodule ProcoreV1API.Model.ChecklistTemplate4 do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :sections => [ProcoreV1API.Model.ChecklistTemplate4SectionsInner.t] | nil
  }
end

defimpl Poison.Decoder, for: ProcoreV1API.Model.ChecklistTemplate4 do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:sections, :list, ProcoreV1API.Model.ChecklistTemplate4SectionsInner, options)
  end
end
