...
defmodule ProcoreV1API.Model.IncidentWitnessStatementCreateParameters do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.IncidentWitnessStatementCreateParameters do
