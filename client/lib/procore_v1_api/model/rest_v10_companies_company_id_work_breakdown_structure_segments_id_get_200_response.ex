...
defmodule ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkBreakdownStructureSegmentsIdGet200Response do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkBreakdownStructureSegmentsIdGet200Response do
