...
defmodule ProcoreV1API.Model.ArrayOfTaskItemsThatWereSentOutInner do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.ArrayOfTaskItemsThatWereSentOutInner do
