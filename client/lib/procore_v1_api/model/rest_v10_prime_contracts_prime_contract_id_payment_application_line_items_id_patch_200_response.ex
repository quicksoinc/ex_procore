...
defmodule ProcoreV1API.Model.RestV10PrimeContractsPrimeContractIdPaymentApplicationLineItemsIdPatch200Response do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :wbs_code => ProcoreV1API.Model.WbsCode.t | nil,
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10PrimeContractsPrimeContractIdPaymentApplicationLineItemsIdPatch200Response do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:wbs_code, :struct, ProcoreV1API.Model.WbsCode, options)
  end
end
