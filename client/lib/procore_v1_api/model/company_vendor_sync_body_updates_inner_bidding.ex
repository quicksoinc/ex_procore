...
defmodule ProcoreV1API.Model.CompanyVendorSyncBodyUpdatesInnerBidding do
  @moduledoc """
  Bidding statuses
  """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.CompanyVendorSyncBodyUpdatesInnerBidding do
