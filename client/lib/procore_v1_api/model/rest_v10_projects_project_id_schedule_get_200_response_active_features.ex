...
defmodule ProcoreV1API.Model.RestV10ProjectsProjectIdScheduleGet200ResponseActiveFeatures do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10ProjectsProjectIdScheduleGet200ResponseActiveFeatures do
