...
defmodule ProcoreV1API.Model.IncidentNormalAllOfInjuriesInnerAllOf1 do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.IncidentNormalAllOfInjuriesInnerAllOf1 do
