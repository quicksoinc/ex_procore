...
defmodule ProcoreV1API.Model.RestV10BimLevelsGet200ResponseInnerOneOf do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10BimLevelsGet200ResponseInnerOneOf do
