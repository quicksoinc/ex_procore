...
defmodule ProcoreV1API.Model.RestV10ChangeOrderPackagesPost201Response do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :line_items => [ProcoreV1API.Model.RestV10ChangeOrderPackagesPost201ResponseLineItemsInner.t] | nil,
    :currency_configuration => ProcoreV1API.Model.RestV10WorkOrderContractsGet200ResponseInnerCurrencyConfiguration.t | nil
  }
end

defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10ChangeOrderPackagesPost201Response do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:line_items, :list, ProcoreV1API.Model.RestV10ChangeOrderPackagesPost201ResponseLineItemsInner, options)
