...
defmodule ProcoreV1API.Model.RestV10CompaniesCompanyIdBidPackagesGet200ResponseBidPackagesInner do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :links => ProcoreV1API.Model.RestV10CompaniesCompanyIdBidPackagesGet200ResponseBidPackagesInnerLinks.t | nil,
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10CompaniesCompanyIdBidPackagesGet200ResponseBidPackagesInner do
  import ProcoreV1API.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:links, :struct, ProcoreV1API.Model.RestV10CompaniesCompanyIdBidPackagesGet200ResponseBidPackagesInnerLinks, options)
  end
end
