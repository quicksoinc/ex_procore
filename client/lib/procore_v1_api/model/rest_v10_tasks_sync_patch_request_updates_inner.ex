...
defmodule ProcoreV1API.Model.RestV10TasksSyncPatchRequestUpdatesInner do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10TasksSyncPatchRequestUpdatesInner do
