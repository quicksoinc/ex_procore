...
defmodule ProcoreV1API.Model.RestV10BimGeometryFileBundlesPost201Response do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10BimGeometryFileBundlesPost201Response do
