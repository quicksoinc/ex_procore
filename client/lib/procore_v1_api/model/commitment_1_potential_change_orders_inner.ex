...
defmodule ProcoreV1API.Model.Commitment1PotentialChangeOrdersInner do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.Commitment1PotentialChangeOrdersInner do
