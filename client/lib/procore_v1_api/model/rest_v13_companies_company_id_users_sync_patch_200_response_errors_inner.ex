...
defmodule ProcoreV1API.Model.RestV13CompaniesCompanyIdUsersSyncPatch200ResponseErrorsInner do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV13CompaniesCompanyIdUsersSyncPatch200ResponseErrorsInner do
