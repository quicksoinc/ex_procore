...
defmodule ProcoreV1API.Model.RestV10PurchaseOrderContractsPost201ResponseChangeOrderPackagesInner do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10PurchaseOrderContractsPost201ResponseChangeOrderPackagesInner do
