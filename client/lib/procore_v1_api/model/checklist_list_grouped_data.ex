...
defmodule ProcoreV1API.Model.ChecklistListGroupedData do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :closed_by => ProcoreV1API.Model.PunchItem6CreatedBy.t | nil,
    :responsible_contractor => ProcoreV1API.Model.ChecklistListGroupedDataResponsibleContractor.t | nil,
    :point_of_contact => ProcoreV1API.Model.PunchItem6CreatedBy.t | nil,
    :trade => ProcoreV1API.Model.Trade.t | nil,
    :inspectors => [ProcoreV1API.Model.PunchItem6CreatedBy.t] | nil,
    :distribution_members => [ProcoreV1API.Model.PunchItem6CreatedBy.t] | nil,
    ...
    :permissions => ProcoreV1API.Model.ChecklistListGroupedDataPermissions.t | nil,
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.ChecklistListGroupedData do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:closed_by, :struct, ProcoreV1API.Model.PunchItem6CreatedBy, options)
    |> deserialize(:responsible_contractor, :struct, ProcoreV1API.Model.ChecklistListGroupedDataResponsibleContractor, options)
    |> deserialize(:point_of_contact, :struct, ProcoreV1API.Model.PunchItem6CreatedBy, options)
    |> deserialize(:trade, :struct, ProcoreV1API.Model.Trade, options)
    |> deserialize(:inspectors, :list, ProcoreV1API.Model.PunchItem6CreatedBy, options)
    |> deserialize(:distribution_members, :list, ProcoreV1API.Model.PunchItem6CreatedBy, options)
    ...
    |> deserialize(:permissions, :struct, ProcoreV1API.Model.ChecklistListGroupedDataPermissions, options)
