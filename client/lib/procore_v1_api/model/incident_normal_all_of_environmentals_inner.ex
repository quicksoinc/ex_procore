...
defmodule ProcoreV1API.Model.IncidentNormalAllOfEnvironmentalsInner do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.IncidentNormalAllOfEnvironmentalsInner do
