...
defmodule ProcoreV1API.Model.RestV10ProjectsProjectIdManpowerLogsGet200ResponseInnerContact do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10ProjectsProjectIdManpowerLogsGet200ResponseInnerContact do
