...
defmodule ProcoreV1API.Model.RestV10PotentialChangeOrdersPost201Response do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10PotentialChangeOrdersPost201Response do
