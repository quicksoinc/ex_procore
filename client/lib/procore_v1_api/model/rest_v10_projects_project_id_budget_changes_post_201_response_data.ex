...
defmodule ProcoreV1API.Model.RestV10ProjectsProjectIdBudgetChangesPost201ResponseData do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10ProjectsProjectIdBudgetChangesPost201ResponseData do
