...
defmodule ProcoreV1API.Model.Commitment1 do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :change_order_requests => [[ProcoreV1API.Model.Commitment1ChangeOrderRequestsInnerInner.t]] | nil,
    ...
    :line_items => [ProcoreV1API.Model.RestV10WorkOrderContractsWorkOrderContractIdLineItemsSyncPatch200ResponseErrorsInnerAllOf.t] | nil,
    :potential_change_orders => [ProcoreV1API.Model.Commitment1PotentialChangeOrdersInner.t] | nil,
    :payments_issued => [ProcoreV1API.Model.Commitment1PaymentsIssuedInner.t] | nil,
    :received_from => ProcoreV1API.Model.RestV10ProjectsProjectIdWorkLogsGet200ResponseInnerCreatedBy.t | nil
  }
end

defimpl Poison.Decoder, for: ProcoreV1API.Model.Commitment1 do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:change_order_packages, :list, ProcoreV1API.Model.RfqChangeOrderPackages, options)
    ...
    |> deserialize(:line_items, :list, ProcoreV1API.Model.RestV10WorkOrderContractsWorkOrderContractIdLineItemsSyncPatch200ResponseErrorsInnerAllOf, options)
    |> deserialize(:potential_change_orders, :list, ProcoreV1API.Model.Commitment1PotentialChangeOrdersInner, options)
    |> deserialize(:payments_issued, :list, ProcoreV1API.Model.Commitment1PaymentsIssuedInner, options)
