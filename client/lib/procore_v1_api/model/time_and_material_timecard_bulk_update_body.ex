...
defmodule ProcoreV1API.Model.TimeAndMaterialTimecardBulkUpdateBody do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.TimeAndMaterialTimecardBulkUpdateBody do
