...
defmodule ProcoreV1API.Model.RestV10ChangeOrderPackagesIdGet200ResponseLineItemsInner do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :markup_line_items => [ProcoreV1API.Model.RestV10ChangeOrderPackagesIdGet200ResponseLineItemsInnerMarkupLineItemsInner.t] | nil,
    :currency_configuration => ProcoreV1API.Model.RestV10WorkOrderContractsGet200ResponseInnerCurrencyConfiguration.t | nil
  }
end

defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10ChangeOrderPackagesIdGet200ResponseLineItemsInner do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:markup_line_items, :list, ProcoreV1API.Model.RestV10ChangeOrderPackagesIdGet200ResponseLineItemsInnerMarkupLineItemsInner, options)
