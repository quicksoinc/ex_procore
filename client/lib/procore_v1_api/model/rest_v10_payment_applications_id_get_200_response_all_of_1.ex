...
defmodule ProcoreV1API.Model.RestV10PaymentApplicationsIdGet200ResponseAllOf1 do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10PaymentApplicationsIdGet200ResponseAllOf1 do
