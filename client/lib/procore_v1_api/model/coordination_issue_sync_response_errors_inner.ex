...
defmodule ProcoreV1API.Model.CoordinationIssueSyncResponseErrorsInner do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.CoordinationIssueSyncResponseErrorsInner do
