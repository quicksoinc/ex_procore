...
defmodule ProcoreV1API.Model.RestV10PaymentApplicationsGet200ResponseInnerAllOfG702 do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10PaymentApplicationsGet200ResponseInnerAllOfG702 do
