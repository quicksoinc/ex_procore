...
defmodule ProcoreV1API.Model.RestV10ProjectsProjectIdIncidentsInjuriesGet200ResponseInnerAllOf do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10ProjectsProjectIdIncidentsInjuriesGet200ResponseInnerAllOf do
