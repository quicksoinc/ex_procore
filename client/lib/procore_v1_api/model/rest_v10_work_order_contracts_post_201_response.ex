...
defmodule ProcoreV1API.Model.RestV10WorkOrderContractsPost201Response do
  @moduledoc """
  Work Order Contract
  """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10WorkOrderContractsPost201Response do
