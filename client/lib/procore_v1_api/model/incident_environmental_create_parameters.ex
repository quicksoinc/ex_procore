...
defmodule ProcoreV1API.Model.IncidentEnvironmentalCreateParameters do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.IncidentEnvironmentalCreateParameters do
