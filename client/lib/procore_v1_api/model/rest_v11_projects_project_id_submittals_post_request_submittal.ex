...
defmodule ProcoreV1API.Model.RestV11ProjectsProjectIdSubmittalsPostRequestSubmittal do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :title => String.t | nil,
    :type => String.t | nil,
    :workflow_data => [[ProcoreV1API.Model.RestV11ProjectsProjectIdSubmittalsPostRequestSubmittalWorkflowDataInnerInner.t]] | nil,
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV11ProjectsProjectIdSubmittalsPostRequestSubmittal do
