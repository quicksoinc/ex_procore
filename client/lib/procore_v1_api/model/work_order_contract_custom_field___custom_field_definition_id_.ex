...
defmodule ProcoreV1API.Model.WorkOrderContractCustomFieldCustomFieldDefinitionId do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.WorkOrderContractCustomFieldCustomFieldDefinitionId do
