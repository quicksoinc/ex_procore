...
defmodule ProcoreV1API.Model.DrawingUpload do
  @moduledoc """
  Drawing Upload
  """
  ...
  @type t :: %__MODULE__{
    ...
    :drawing_log_imports => [ProcoreV1API.Model.DrawingLogImport.t] | nil
  }
end

defimpl Poison.Decoder, for: ProcoreV1API.Model.DrawingUpload do
  import ProcoreV1API.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:drawing_log_imports, :list, ProcoreV1API.Model.DrawingLogImport, options)
  end
end
