...
defmodule ProcoreV1API.Model.RfiBodyRfi do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :question => ProcoreV1API.Model.RfiBodyRfiQuestion.t,
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RfiBodyRfi do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:question, :struct, ProcoreV1API.Model.RfiBodyRfiQuestion, options)
