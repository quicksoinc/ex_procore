...
defmodule ProcoreV1API.Model.RestV10WorkOrderContractsPost201ResponsePotentialChangeOrdersInner do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10WorkOrderContractsPost201ResponsePotentialChangeOrdersInner do
