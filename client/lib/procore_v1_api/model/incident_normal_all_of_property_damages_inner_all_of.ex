...
defmodule ProcoreV1API.Model.IncidentNormalAllOfPropertyDamagesInnerAllOf do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.IncidentNormalAllOfPropertyDamagesInnerAllOf do
