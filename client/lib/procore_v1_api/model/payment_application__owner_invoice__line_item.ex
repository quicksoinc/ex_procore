...
defmodule ProcoreV1API.Model.PaymentApplicationOwnerInvoiceLineItem do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.PaymentApplicationOwnerInvoiceLineItem do
