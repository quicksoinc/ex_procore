...
defmodule ProcoreV1API.Model.RestV11ProjectsProjectIdVendorsGet200ResponseInner do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV11ProjectsProjectIdVendorsGet200ResponseInner do
