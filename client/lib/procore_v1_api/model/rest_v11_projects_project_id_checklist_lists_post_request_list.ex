...
defmodule ProcoreV1API.Model.RestV11ProjectsProjectIdChecklistListsPostRequestList do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV11ProjectsProjectIdChecklistListsPostRequestList do
