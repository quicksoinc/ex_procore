...
defmodule ProcoreV1API.Model.RestV10BimGeometryFileBundlesIdGet200ResponseOneOf do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10BimGeometryFileBundlesIdGet200ResponseOneOf do
