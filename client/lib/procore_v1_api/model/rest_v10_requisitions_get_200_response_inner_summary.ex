...
defmodule ProcoreV1API.Model.RestV10RequisitionsGet200ResponseInnerSummary do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10RequisitionsGet200ResponseInnerSummary do
