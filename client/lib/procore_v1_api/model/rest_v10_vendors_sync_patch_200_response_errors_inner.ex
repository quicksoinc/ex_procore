...
defmodule ProcoreV1API.Model.RestV10VendorsSyncPatch200ResponseErrorsInner do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreV1API.Model.RestV10VendorsSyncPatch200ResponseErrorsInner do
