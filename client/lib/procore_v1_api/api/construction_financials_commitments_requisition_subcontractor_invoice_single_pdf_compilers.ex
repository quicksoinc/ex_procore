...
defmodule ProcoreV1API.Api.ConstructionFinancialsCommitmentsRequisitionSubcontractorInvoiceSinglePDFCompilers do
  @moduledoc """
  ...
  - `{:ok, ProcoreV1API.Model.RestV10RequisitionsRequisitionIdSinglePdfCompilersPost200Response.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_requisitions_requisition_id_single_pdf_compilers_post(Tesla.Env.client, integer(), integer(), integer(), ProcoreV1API.Model.Body20.t, keyword()) :: {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreV1API.Model.RestV10WorkOrderContractsWorkOrderContractIdSubcontractorScheduleOfValuesStatusPatch404Response.t} | {:ok, ProcoreV1API.Model.RestV10RequisitionsRequisitionIdSinglePdfCompilersPost200Response.t} | {:error, Tesla.Env.t}
  def rest_v10_requisitions_requisition_id_single_pdf_compilers_post(connection, procore_company_id, requisition_id, project_id, body20, opts \\ []) do
    optional_params = %{
      :polling => :query
    }
    ...
    |> evaluate_response([
      {200, %ProcoreV1API.Model.RestV10RequisitionsRequisitionIdSinglePdfCompilersPost200Response{}},
