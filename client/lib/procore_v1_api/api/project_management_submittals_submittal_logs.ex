...
defmodule ProcoreV1API.Api.ProjectManagementSubmittalsSubmittalLogs do
  @moduledoc """
  ...
  """
  @spec rest_v10_submittal_logs_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, list(ProcoreV1API.Model.RestV10SubmittalLogsGet200ResponseInner.t)} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_submittal_logs_get(connection, procore_company_id, project_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreV1API.Model.RestV10SubmittalLogsGet200ResponseInner{}]},
  ...
  - `{:ok, ProcoreV1API.Model.RestV10SubmittalLogsIdGet200Response.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_submittal_logs_id_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, ProcoreV1API.Model.RestV10SubmittalLogsIdGet200Response.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_submittal_logs_id_get(connection, procore_company_id, id, project_id, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %ProcoreV1API.Model.RestV10SubmittalLogsIdGet200Response{}},
      {400, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {401, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {403, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}}
    ])
