...
defmodule ProcoreV1API.Api.QualitySafetyIncidentsAlerts do
  @moduledoc """
  ...
  """
  @spec rest_v10_projects_project_id_incidents_alerts_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, list(ProcoreV1API.Model.RestV10ProjectsProjectIdIncidentsAlertsGet200ResponseInner.t)} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_projects_project_id_incidents_alerts_get(connection, procore_company_id, project_id, opts \\ []) do
    optional_params = %{
      :incident_id => :query,
      :page => :query,
      :per_page => :query,
    ...
    |> evaluate_response([
      {200, [%ProcoreV1API.Model.RestV10ProjectsProjectIdIncidentsAlertsGet200ResponseInner{}]},
  ...
  - `{:ok, ProcoreV1API.Model.RestV10ProjectsProjectIdIncidentsAlertsGet200ResponseInner.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_incidents_alerts_id_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, ProcoreV1API.Model.RestV10ProjectsProjectIdIncidentsAlertsGet200ResponseInner.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_projects_project_id_incidents_alerts_id_get(connection, procore_company_id, project_id, id, _opts \\ []) do
    request =
      %{}
      |> method(:get)
