...
defmodule ProcoreV1API.Api.ProjectManagementCoordinationIssuesCoordinationIssueChangeHistory do
  @moduledoc """
  ...
  """
  @spec rest_v10_coordination_issues_id_change_history_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, list(ProcoreV1API.Model.RestV10CoordinationIssuesIdChangeHistoryGet200ResponseInner.t)} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_coordination_issues_id_change_history_get(connection, procore_company_id, id, project_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreV1API.Model.RestV10CoordinationIssuesIdChangeHistoryGet200ResponseInner{}]},
