...
defmodule ProcoreV1API.Api.ProjectManagementModelsBIMModelChangeHistory do
  @moduledoc """
  ...
  """
  @spec rest_v10_bim_models_id_change_history_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, list(ProcoreV1API.Model.RestV10ProjectsProjectIdTimeAndMaterialEntriesIdChangeHistoryGet304Response.t)} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
