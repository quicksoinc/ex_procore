...
defmodule ProcoreV1API.Api.ProjectManagementCoordinationIssuesCoordinationIssueCounts do
  @moduledoc """
  ...
  """
  @spec rest_v10_coordination_issues_status_count_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, list(ProcoreV1API.Model.RestV10CoordinationIssuesStatusCountGet200ResponseInner.t)} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_coordination_issues_status_count_get(connection, procore_company_id, project_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreV1API.Model.RestV10CoordinationIssuesStatusCountGet200ResponseInner{}]},
