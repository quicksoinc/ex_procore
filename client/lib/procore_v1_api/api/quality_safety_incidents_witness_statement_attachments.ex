...
defmodule ProcoreV1API.Api.QualitySafetyIncidentsWitnessStatementAttachments do
  @moduledoc """
  ...
  """
  @spec rest_v10_projects_project_id_incidents_witness_statements_witness_statement_id_attachments_post(Tesla.Env.client, integer(), integer(), integer(), String.t, keyword()) :: {:ok, ProcoreV1API.Model.IncidentAttachment1.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
