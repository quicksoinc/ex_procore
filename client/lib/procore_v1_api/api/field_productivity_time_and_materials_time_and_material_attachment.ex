...
defmodule ProcoreV1API.Api.FieldProductivityTimeAndMaterialsTimeAndMaterialAttachment do
  @moduledoc """
  ...
  """
  @spec rest_v10_projects_project_id_time_and_material_entry_attachments_bulk_destroy_delete(Tesla.Env.client, integer(), integer(), ProcoreV1API.Model.RestV10ProjectsProjectIdTimeAndMaterialEntryAttachmentsBulkDestroyDeleteRequest.t, keyword()) :: {:ok, list(ProcoreV1API.Model.RestV10ProjectsProjectIdTimeAndMaterialEntryAttachmentsGet200ResponseInner.t)} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_projects_project_id_time_and_material_entry_attachments_bulk_destroy_delete(connection, procore_company_id, project_id, rest_v10_projects_project_id_time_and_material_entry_attachments_bulk_destroy_delete_request, _opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreV1API.Model.RestV10ProjectsProjectIdTimeAndMaterialEntryAttachmentsGet200ResponseInner{}]},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_time_and_material_entry_attachments_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, list(ProcoreV1API.Model.RestV10ProjectsProjectIdTimeAndMaterialEntryAttachmentsGet200ResponseInner.t)} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:ok, ProcoreV1API.Model.RestV10ProjectsProjectIdTimeAndMaterialEntryAttachmentsGet200ResponseInner.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_time_and_material_entry_attachments_id_delete(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreV1API.Model.RestV10ProjectsProjectIdTimeAndMaterialEntryAttachmentsGet200ResponseInner.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_time_and_material_entry_attachments_id_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreV1API.Model.RestV10ProjectsProjectIdTimeAndMaterialEntryAttachmentsGet200ResponseInner.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_time_and_material_entry_attachments_post(Tesla.Env.client, integer(), integer(), ProcoreV1API.Model.RestV10ProjectsProjectIdTimeAndMaterialEntryAttachmentsPostRequest.t, keyword()) :: {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreV1API.Model.RestV10ProjectsProjectIdTimeAndMaterialEntryAttachmentsGet200ResponseInner.t} | {:error, Tesla.Env.t}
  def rest_v10_projects_project_id_time_and_material_entry_attachments_post(connection, procore_company_id, project_id, rest_v10_projects_project_id_time_and_material_entry_attachments_post_request, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {201, %ProcoreV1API.Model.RestV10ProjectsProjectIdTimeAndMaterialEntryAttachmentsGet200ResponseInner{}},
      {400, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {401, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {403, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}}
    ])
