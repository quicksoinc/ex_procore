...
defmodule ProcoreV1API.Api.CoreCompanyDirectoryCompanyInactivePeople do
  @moduledoc """
  ...
  """
  @spec rest_v10_companies_company_id_people_inactive_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, list(ProcoreV1API.Model.CompanyPerson.t)} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
