...
defmodule ProcoreV1API.Api.ConstructionFinancialsCommitmentsRequisitionSubcontractorInvoiceChangeOrderItems do
  @moduledoc """
  ...
  def rest_v10_requisitions_requisition_id_change_order_items_get(connection, procore_company_id, requisition_id, project_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreV1API.Model.RestV10RequisitionsRequisitionIdChangeOrderItemsGet200ResponseInner{}]},
  ...
  - `{:ok, ProcoreV1API.Model.RestV10RequisitionsRequisitionIdChangeOrderItemsGet200ResponseInner.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_requisitions_requisition_id_change_order_items_id_get(Tesla.Env.client, integer(), integer(), integer(), integer(), keyword()) :: {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreV1API.Model.RestV10WorkOrderContractsWorkOrderContractIdSubcontractorScheduleOfValuesStatusPatch404Response.t} | {:ok, ProcoreV1API.Model.RestV10RequisitionsRequisitionIdChangeOrderItemsGet200ResponseInner.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_requisitions_requisition_id_change_order_items_id_patch(Tesla.Env.client, integer(), integer(), integer(), integer(), ProcoreV1API.Model.Body23.t, keyword()) :: {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreV1API.Model.RestV10WorkOrderContractsWorkOrderContractIdSubcontractorScheduleOfValuesStatusPatch404Response.t} | {:ok, ProcoreV1API.Model.RestV10RequisitionsRequisitionIdChangeOrderItemsGet200ResponseInner.t} | {:error, Tesla.Env.t}
