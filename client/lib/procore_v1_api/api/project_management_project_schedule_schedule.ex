...
defmodule ProcoreV1API.Api.ProjectManagementProjectScheduleSchedule do
  @moduledoc """
  ...
  - `{:ok, ProcoreV1API.Model.RestV10ProjectsProjectIdScheduleGet200Response.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_schedule_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, ProcoreV1API.Model.RestV10ProjectsProjectIdScheduleGet200Response.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_projects_project_id_schedule_get(connection, procore_company_id, project_id, _opts \\ []) do
    request =
      %{}
      |> method(:get)
    ...
    |> evaluate_response([
      {200, %ProcoreV1API.Model.RestV10ProjectsProjectIdScheduleGet200Response{}},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_schedule_patch(Tesla.Env.client, integer(), integer(), ProcoreV1API.Model.Body15.t, keyword()) :: {:ok, ProcoreV1API.Model.RestV10ProjectsProjectIdScheduleGet200Response.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_projects_project_id_schedule_patch(connection, procore_company_id, project_id, body15, _opts \\ []) do
    request =
      %{}
      |> method(:patch)
      |> url("/rest/v1.0/projects/#{project_id}/schedule")
