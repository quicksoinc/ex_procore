...
defmodule ProcoreV1API.Api.QualitySafetyInspectionsChecklistItemObservations do
  @moduledoc """
  ...
  """
  @spec rest_v10_projects_project_id_checklist_list_item_observations_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, list(ProcoreV1API.Model.ChecklistInspectionItemObservation.t)} | {:error, Tesla.Env.t}
  def rest_v10_projects_project_id_checklist_list_item_observations_get(connection, procore_company_id, project_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreV1API.Model.ChecklistInspectionItemObservation{}]},
