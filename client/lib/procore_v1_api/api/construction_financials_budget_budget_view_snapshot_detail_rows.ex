...
defmodule ProcoreV1API.Api.ConstructionFinancialsBudgetBudgetViewSnapshotDetailRows do
  @moduledoc """
  ...
  """
  @spec rest_v10_budget_view_snapshots_budget_view_snapshot_id_detail_rows_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, list(ProcoreV1API.Model.RestV10BudgetViewSnapshotsBudgetViewSnapshotIdDetailRowsGet200ResponseInner.t)} | {:error, Tesla.Env.t}
