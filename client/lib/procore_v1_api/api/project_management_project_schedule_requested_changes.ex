...
defmodule ProcoreV1API.Api.ProjectManagementProjectScheduleRequestedChanges do
  @moduledoc """
  ...
  - `{:ok, ProcoreV1API.Model.RestV10RequestedChangesGet200Response.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_requested_changes_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreV1API.Model.RestV10RequestedChangesGet200Response.t} | {:error, Tesla.Env.t}
  def rest_v10_requested_changes_get(connection, procore_company_id, project_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, %ProcoreV1API.Model.RestV10RequestedChangesGet200Response{}},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_requested_changes_post(Tesla.Env.client, integer(), integer(), integer(), ProcoreV1API.Model.RestV11ProjectsProjectIdScheduleTasksTaskIdRequestedChangesPostRequest.t, keyword()) :: {:ok, ProcoreV1API.Model.RestV11ProjectsProjectIdScheduleRequestedChangesGet200ResponseInner.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_requested_changes_review_patch(Tesla.Env.client, integer(), integer(), ProcoreV1API.Model.RestV11ProjectsProjectIdScheduleRequestedChangesReviewPatchRequest.t, keyword()) :: {:ok, list(ProcoreV1API.Model.RestV11ProjectsProjectIdScheduleRequestedChangesReviewPatch200ResponseInner.t)} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
