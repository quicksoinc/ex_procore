...
defmodule ProcoreV1API.Api.CoreProjectUserProjectRoles do
  @moduledoc """
  ...
  - `{:ok, ProcoreV1API.Model.UserProjectRole.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_user_project_roles_id_patch(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, ProcoreV1API.Model.UserProjectRole.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreV1API.Model.RestV10WorkOrderContractsWorkOrderContractIdSubcontractorScheduleOfValuesStatusPatch404Response.t} | {:error, Tesla.Env.t}
  def rest_v10_projects_project_id_user_project_roles_id_patch(connection, procore_company_id, id, project_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, %ProcoreV1API.Model.UserProjectRole{}},
