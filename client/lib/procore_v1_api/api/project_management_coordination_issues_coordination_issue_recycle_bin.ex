...
defmodule ProcoreV1API.Api.ProjectManagementCoordinationIssuesCoordinationIssueRecycleBin do
  @moduledoc """
  ...
  """
  @spec rest_v10_coordination_issues_recycle_bin_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, list(ProcoreV1API.Model.RestV10CoordinationIssuesGet200ResponseInner.t)} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_coordination_issues_recycle_bin_id_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, ProcoreV1API.Model.RestV10CoordinationIssuesGet200ResponseInner.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_coordination_issues_recycle_bin_id_patch(Tesla.Env.client, integer(), integer(), ProcoreV1API.Model.RestV10CoordinationIssuesRecycleBinIdPatchRequest.t, keyword()) :: {:ok, nil} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
