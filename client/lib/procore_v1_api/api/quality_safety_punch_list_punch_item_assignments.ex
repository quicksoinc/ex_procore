...
defmodule ProcoreV1API.Api.QualitySafetyPunchListPunchItemAssignments do
  @moduledoc """
  ...
  - `{:ok, ProcoreV1API.Model.RestV10ProjectsProjectIdPunchItemAssignmentsIdGet200Response.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_punch_item_assignments_id_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, ProcoreV1API.Model.RestV10ProjectsProjectIdPunchItemAssignmentsIdGet200Response.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_projects_project_id_punch_item_assignments_id_get(connection, procore_company_id, id, project_id, _opts \\ []) do
    ...
    |> evaluate_response([
      {200, %ProcoreV1API.Model.RestV10ProjectsProjectIdPunchItemAssignmentsIdGet200Response{}},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_punch_item_assignments_id_patch(Tesla.Env.client, integer(), integer(), integer(), ProcoreV1API.Model.RestV10ProjectsProjectIdPunchItemAssignmentsIdPatchRequest.t, keyword()) :: {:ok, ProcoreV1API.Model.RestV10ProjectsProjectIdPunchItemAssignmentsIdGet200Response.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
