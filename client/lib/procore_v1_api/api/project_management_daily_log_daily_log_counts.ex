...
defmodule ProcoreV1API.Api.ProjectManagementDailyLogDailyLogCounts do
  @moduledoc """
  ...
  """
  @spec rest_v11_projects_project_id_daily_logs_counts_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, list(ProcoreV1API.Model.RestV10ProjectsProjectIdDailyLogsCountGet200ResponseInner.t)} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v11_projects_project_id_daily_logs_counts_get(connection, procore_company_id, project_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreV1API.Model.RestV10ProjectsProjectIdDailyLogsCountGet200ResponseInner{}]},
