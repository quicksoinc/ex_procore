...
defmodule ProcoreV1API.Api.ProjectManagementProjectScheduleToDos do
  @moduledoc """
  ...
  """
  @spec rest_v10_todos_id_delete(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, nil} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:ok, ProcoreV1API.Model.ToDo1.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_todos_id_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, ProcoreV1API.Model.ToDo1.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_todos_id_patch(Tesla.Env.client, integer(), integer(), ProcoreV1API.Model.Body11.t, keyword()) :: {:ok, ProcoreV1API.Model.ToDo1.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_todos_post(Tesla.Env.client, integer(), ProcoreV1API.Model.Body10.t, keyword()) :: {:ok, ProcoreV1API.Model.ToDo1.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:ok, ProcoreV1API.Model.ArrayOfTodos.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_todos_sync_patch(Tesla.Env.client, integer(), integer(), ProcoreV1API.Model.RestV10TodosSyncPatchRequest.t, keyword()) :: {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreV1API.Model.ArrayOfTodos.t} | {:error, Tesla.Env.t}
  def rest_v10_todos_sync_patch(connection, procore_company_id, project_id, rest_v10_todos_sync_patch_request, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %ProcoreV1API.Model.ArrayOfTodos{}},
      {400, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {401, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {403, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {:default, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}}
