...
defmodule ProcoreV1API.Api.QualitySafetyInspectionsChecklistItemTypes do
  @moduledoc """
  ...
  """
  @spec rest_v10_checklist_item_types_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, list(ProcoreV1API.Model.ChecklistItemType.t)} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_checklist_item_types_get(connection, procore_company_id, project_id, company_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreV1API.Model.ChecklistItemType{}]},
  ...
  - `{:ok, ProcoreV1API.Model.ChecklistItemType.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_checklist_item_types_id_get(Tesla.Env.client, integer(), integer(), integer(), integer(), keyword()) :: {:ok, ProcoreV1API.Model.ChecklistItemType.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
