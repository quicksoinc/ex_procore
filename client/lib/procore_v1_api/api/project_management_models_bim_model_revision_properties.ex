...
defmodule ProcoreV1API.Api.ProjectManagementModelsBIMModelRevisionProperties do
  @moduledoc """
  ...
  """
  @spec rest_v10_bim_model_revisions_id_properties_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, list(ProcoreV1API.Model.RestV10BimPropertyFilesIdPropertiesGet200ResponseInner.t)} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
