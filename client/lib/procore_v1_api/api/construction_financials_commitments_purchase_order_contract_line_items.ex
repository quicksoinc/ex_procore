...
defmodule ProcoreV1API.Api.ConstructionFinancialsCommitmentsPurchaseOrderContractLineItems do
  @moduledoc """
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_purchase_order_contracts_purchase_order_contract_id_line_items_id_delete(Tesla.Env.client, integer(), integer(), integer(), integer(), keyword()) :: {:ok, nil} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_purchase_order_contracts_purchase_order_contract_id_line_items_id_get(Tesla.Env.client, integer(), integer(), integer(), integer(), keyword()) :: {:ok, ProcoreV1API.Model.RestV10WorkOrderContractsWorkOrderContractIdLineItemsGet200ResponseInner.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_purchase_order_contracts_purchase_order_contract_id_line_items_id_patch(Tesla.Env.client, integer(), integer(), integer(), ProcoreV1API.Model.Body3.t, keyword()) :: {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreV1API.Model.Default.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_purchase_order_contracts_purchase_order_contract_id_line_items_post(Tesla.Env.client, integer(), integer(), ProcoreV1API.Model.Body3.t, keyword()) :: {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreV1API.Model.Default.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_purchase_order_contracts_purchase_order_contract_id_line_items_sync_patch(Tesla.Env.client, integer(), integer(), integer(), ProcoreV1API.Model.LineItemSyncBody.t, keyword()) :: {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreV1API.Model.RestV10WorkOrderContractsWorkOrderContractIdLineItemsSyncPatch200Response.t} | {:error, Tesla.Env.t}
