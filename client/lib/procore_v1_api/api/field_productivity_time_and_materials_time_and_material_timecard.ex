...
defmodule ProcoreV1API.Api.FieldProductivityTimeAndMaterialsTimeAndMaterialTimecard do
  @moduledoc """
  ...
  """
  @spec rest_v10_projects_project_id_time_and_material_timecards_bulk_create_post(Tesla.Env.client, integer(), integer(), ProcoreV1API.Model.TimeAndMaterialTimecardBulkCreateBody.t, keyword()) :: {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, list(ProcoreV1API.Model.RestV10ProjectsProjectIdTimeAndMaterialTimecardsGet200ResponseInner.t)} | {:error, Tesla.Env.t}
  def rest_v10_projects_project_id_time_and_material_timecards_bulk_create_post(connection, procore_company_id, project_id, time_and_material_timecard_bulk_create_body, _opts \\ []) do
    ...
    |> evaluate_response([
      {201, [%ProcoreV1API.Model.RestV10ProjectsProjectIdTimeAndMaterialTimecardsGet200ResponseInner{}]},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_time_and_material_timecards_bulk_destroy_delete(Tesla.Env.client, integer(), integer(), ProcoreV1API.Model.TimeAndMaterialTimecardBulkDestroyBody.t, keyword()) :: {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, list(ProcoreV1API.Model.RestV10ProjectsProjectIdTimeAndMaterialTimecardsGet200ResponseInner.t)} | {:error, Tesla.Env.t}
  def rest_v10_projects_project_id_time_and_material_timecards_bulk_destroy_delete(connection, procore_company_id, project_id, time_and_material_timecard_bulk_destroy_body, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%ProcoreV1API.Model.RestV10ProjectsProjectIdTimeAndMaterialTimecardsGet200ResponseInner{}]},
      {400, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {401, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {403, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}}
    ])
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_time_and_material_timecards_bulk_update_patch(Tesla.Env.client, integer(), integer(), ProcoreV1API.Model.TimeAndMaterialTimecardBulkUpdateBody.t, keyword()) :: {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, list(ProcoreV1API.Model.RestV10ProjectsProjectIdTimeAndMaterialTimecardsGet200ResponseInner.t)} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_time_and_material_timecards_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, list(ProcoreV1API.Model.RestV10ProjectsProjectIdTimeAndMaterialTimecardsGet200ResponseInner.t)} | {:error, Tesla.Env.t}
  ...
  - `{:ok, ProcoreV1API.Model.RestV10ProjectsProjectIdTimeAndMaterialTimecardsGet200ResponseInner.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_time_and_material_timecards_id_delete(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreV1API.Model.RestV10ProjectsProjectIdTimeAndMaterialTimecardsGet200ResponseInner.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_time_and_material_timecards_id_patch(Tesla.Env.client, integer(), integer(), integer(), ProcoreV1API.Model.TimeAndMaterialTimecardBody.t, keyword()) :: {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreV1API.Model.RestV10ProjectsProjectIdTimeAndMaterialTimecardsGet200ResponseInner.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_time_and_material_timecards_post(Tesla.Env.client, integer(), integer(), ProcoreV1API.Model.TimeAndMaterialTimecardBody.t, keyword()) :: {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreV1API.Model.RestV10ProjectsProjectIdTimeAndMaterialTimecardsGet200ResponseInner.t} | {:error, Tesla.Env.t}
