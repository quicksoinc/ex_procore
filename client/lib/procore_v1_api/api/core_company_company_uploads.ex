...
defmodule ProcoreV1API.Api.CoreCompanyCompanyUploads do
  @moduledoc """
  ...
  - `opts` (keyword): Optional parameters
    ...
    - `:segments` ([ProcoreV1API.Model.UploadSegmentsInner.t]): Upload segments

  ### Returns

  - `{:ok, ProcoreV1API.Model.RestV10ProjectsProjectIdUploadsPost201Response.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_companies_company_id_uploads_post(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreV1API.Model.RestV10ProjectsProjectIdUploadsPost201Response.t} | {:error, Tesla.Env.t}
  def rest_v10_companies_company_id_uploads_post(connection, procore_company_id, company_id, opts \\ []) do
    ...
    |> evaluate_response([
      {201, %ProcoreV1API.Model.RestV10ProjectsProjectIdUploadsPost201Response{}},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_companies_company_id_uploads_uuid_get(Tesla.Env.client, integer(), integer(), String.t, keyword()) :: {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreV1API.Model.RestV10ProjectsProjectIdUploadsPost201Response.t} | {:error, Tesla.Env.t}
  def rest_v10_companies_company_id_uploads_uuid_get(connection, procore_company_id, company_id, uuid, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %ProcoreV1API.Model.RestV10ProjectsProjectIdUploadsPost201Response{}},
      {401, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {403, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {:default, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}}
    ])
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_companies_company_id_uploads_uuid_patch(Tesla.Env.client, integer(), integer(), String.t, keyword()) :: {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreV1API.Model.RestV10ProjectsProjectIdUploadsPost201Response.t} | {:error, Tesla.Env.t}
