...
defmodule ProcoreV1API.Api.ProjectManagementModelsBIMPropertyFileProperties do
  @moduledoc """
  ...
  """
  @spec rest_v10_bim_property_files_id_properties_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, list(ProcoreV1API.Model.RestV10BimPropertyFilesIdPropertiesGet200ResponseInner.t)} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_bim_property_files_id_properties_get(connection, procore_company_id, id, project_id, opts \\ []) do
    optional_params = %{
      :page => :query,
      :per_page => :query,
    ...
    |> evaluate_response([
      {200, [%ProcoreV1API.Model.RestV10BimPropertyFilesIdPropertiesGet200ResponseInner{}]},
