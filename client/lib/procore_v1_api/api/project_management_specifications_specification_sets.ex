...
defmodule ProcoreV1API.Api.ProjectManagementSpecificationsSpecificationSets do
  @moduledoc """
  ...
  def rest_v10_projects_project_id_specification_sets_get(connection, procore_company_id, project_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreV1API.Model.RestV10ProjectsProjectIdSpecificationSetsGet200ResponseInner{}]},
  ...
  - `{:ok, ProcoreV1API.Model.RestV10ProjectsProjectIdSpecificationSetsGet200ResponseInner.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_specification_sets_id_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, ProcoreV1API.Model.RestV10ProjectsProjectIdSpecificationSetsGet200ResponseInner.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreV1API.Model.RestV10WorkOrderContractsWorkOrderContractIdSubcontractorScheduleOfValuesStatusPatch404Response.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdProjectsProjectIdTaskItemCommentsPost403Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_specification_sets_post(Tesla.Env.client, integer(), integer(), ProcoreV1API.Model.RestV10ProjectsProjectIdSpecificationSetsPostRequest.t, keyword()) :: {:ok, ProcoreV1API.Model.RestV10ProjectsProjectIdSpecificationSetsGet200ResponseInner.t} | {:ok, ProcoreV1API.Model.RestV10WorkOrderContractsWorkOrderContractIdLineItemsSyncPatch200ResponseErrorsInnerAllOf1.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdProjectsProjectIdTaskItemCommentsPost403Response.t} | {:error, Tesla.Env.t}
  def rest_v10_projects_project_id_specification_sets_post(connection, procore_company_id, project_id, rest_v10_projects_project_id_specification_sets_post_request, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {201, %ProcoreV1API.Model.RestV10ProjectsProjectIdSpecificationSetsGet200ResponseInner{}},
