...
defmodule ProcoreV1API.Api.QualitySafetyInspectionsAlternativeResponseSets do
  @moduledoc """
  ...
  """
  @spec rest_v10_companies_company_id_checklist_alternative_response_sets_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, list(ProcoreV1API.Model.ChecklistAlternativeResponseSetFull.t)} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_companies_company_id_checklist_alternative_response_sets_get(connection, procore_company_id, company_id, _opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreV1API.Model.ChecklistAlternativeResponseSetFull{}]},
  ...
  - `{:ok, ProcoreV1API.Model.ChecklistAlternativeResponseSetFull.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_companies_company_id_checklist_alternative_response_sets_id_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreV1API.Model.ChecklistAlternativeResponseSetFull.t} | {:error, Tesla.Env.t}
