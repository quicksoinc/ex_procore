...
defmodule ProcoreV1API.Api.ConstructionFinancialsBudgetBudgetViewSnapshotSummaryRows do
  @moduledoc """
  ...
  def rest_v10_budget_view_snapshots_budget_view_snapshot_id_summary_rows_get(connection, procore_company_id, budget_view_snapshot_id, project_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreV1API.Model.RestV10BudgetViewSnapshotsBudgetViewSnapshotIdSummaryRowsGet200ResponseInner{}]},
