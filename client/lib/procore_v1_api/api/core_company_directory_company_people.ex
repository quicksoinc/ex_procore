...
defmodule ProcoreV1API.Api.CoreCompanyDirectoryCompanyPeople do
  @moduledoc """
  ...
  """
  @spec rest_v10_companies_company_id_people_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, list(ProcoreV1API.Model.CompanyPerson.t)} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_companies_company_id_people_get(connection, procore_company_id, company_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreV1API.Model.CompanyPerson{}]},
  ...
  - `{:ok, ProcoreV1API.Model.CompanyPerson.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_companies_company_id_people_id_patch(Tesla.Env.client, integer(), integer(), integer(), ProcoreV1API.Model.CompanyPersonBody.t, keyword()) :: {:ok, ProcoreV1API.Model.CompanyPerson.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
