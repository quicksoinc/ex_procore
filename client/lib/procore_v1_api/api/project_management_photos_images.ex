...
defmodule ProcoreV1API.Api.ProjectManagementPhotosImages do
  @moduledoc """
  ...
  """
  @spec rest_v10_images_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, list(ProcoreV1API.Model.Image.t)} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_images_id_delete(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, nil} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:ok, ProcoreV1API.Model.Image.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_images_id_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, ProcoreV1API.Model.Image.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_images_id_patch(Tesla.Env.client, integer(), integer(), integer(), ProcoreV1API.Model.Body73.t, keyword()) :: {:ok, ProcoreV1API.Model.Image.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  ...
  - `image` (ProcoreV1API.Model.Image1.t): 
  - `opts` (keyword): Optional parameters
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_images_post(Tesla.Env.client, integer(), integer(), String.t, ProcoreV1API.Model.ProcoreV1API.Model.Image1.t, keyword()) :: {:ok, ProcoreV1API.Model.Image.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
