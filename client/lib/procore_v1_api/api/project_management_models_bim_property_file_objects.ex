...
defmodule ProcoreV1API.Api.ProjectManagementModelsBIMPropertyFileObjects do
  @moduledoc """
  ...
  """
  @spec rest_v10_bim_property_files_id_objects_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, list(ProcoreV1API.Model.RestV10BimPropertyFilesIdObjectsGet200ResponseInner.t)} | {:error, Tesla.Env.t}
