...
defmodule ProcoreV1API.Api.QualitySafetyActionPlansProjectActionPlanTemplateItemAssignees do
  @moduledoc """
  ...
  def rest_v10_projects_project_id_action_plans_plan_template_item_assignees_get(connection, procore_company_id, project_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreV1API.Model.RestV10ProjectsProjectIdActionPlansPlanTemplateItemAssigneesGet200ResponseInner{}]},
