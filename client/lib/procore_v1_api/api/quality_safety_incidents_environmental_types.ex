...
defmodule ProcoreV1API.Api.QualitySafetyIncidentsEnvironmentalTypes do
  @moduledoc """
  ...
  """
  @spec rest_v10_companies_company_id_incidents_environmental_types_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, list(ProcoreV1API.Model.EnvironmentalType.t)} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_companies_company_id_incidents_environmental_types_get(connection, procore_company_id, company_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreV1API.Model.EnvironmentalType{}]},
