...
defmodule ProcoreV1API.Api.ProjectManagementProjectScheduleScheduleIntegration do
  @moduledoc """
  ...
  """
  @spec rest_v10_schedule_integration_download_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, nil} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_schedule_integration_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, list(ProcoreV1API.Model.RestV10ScheduleIntegrationGet200ResponseInner.t)} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_schedule_integration_get(connection, procore_company_id, project_id, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%ProcoreV1API.Model.RestV10ScheduleIntegrationGet200ResponseInner{}]},
      {401, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {403, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {:default, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}}
    ])
  ...
  - `procore_company_id` (integer()): Unique company identifier associated with the Procore User Account.
  - `project_id` (integer()): Unique identifier for the project.
  - `schedule_integration` (ProcoreV1API.Model.ScheduleIntegration.t): 
  - `opts` (keyword): Optional parameters
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_schedule_integration_patch(Tesla.Env.client, integer(), integer(), ProcoreV1API.Model.ProcoreV1API.Model.ScheduleIntegration.t, keyword()) :: {:ok, nil} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_schedule_integration_put(Tesla.Env.client, integer(), integer(), ProcoreV1API.Model.ProcoreV1API.Model.ScheduleIntegration.t, keyword()) :: {:ok, nil} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
