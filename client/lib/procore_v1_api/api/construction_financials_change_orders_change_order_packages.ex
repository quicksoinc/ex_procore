...
defmodule ProcoreV1API.Api.ConstructionFinancialsChangeOrdersChangeOrderPackages do
  @moduledoc """
  ...
  """
  @spec rest_v10_change_order_packages_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, list(ProcoreV1API.Model.RestV10ChangeOrderPackagesGet200ResponseInner.t)} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_change_order_packages_get(connection, procore_company_id, project_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreV1API.Model.RestV10ChangeOrderPackagesGet200ResponseInner{}]},
  ...
  - `{:ok, ProcoreV1API.Model.RestV10ChangeOrderPackagesIdGet200Response.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_change_order_packages_id_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, ProcoreV1API.Model.RestV10ChangeOrderPackagesIdGet200Response.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_change_order_packages_id_get(connection, procore_company_id, id, project_id, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %ProcoreV1API.Model.RestV10ChangeOrderPackagesIdGet200Response{}},
      {401, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {403, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {404, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}}
    ])
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_change_order_packages_id_patch(Tesla.Env.client, integer(), integer(), ProcoreV1API.Model.RestV10ChangeOrderPackagesIdPatchRequest.t, keyword()) :: {:ok, ProcoreV1API.Model.RestV10ChangeOrderPackagesIdGet200Response.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:ok, ProcoreV1API.Model.RestV10ChangeOrderPackagesPost201Response.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_change_order_packages_post(Tesla.Env.client, integer(), ProcoreV1API.Model.RestV10ChangeOrderPackagesPostRequest.t, keyword()) :: {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreV1API.Model.RestV10ChangeOrderPackagesPost201Response.t} | {:error, Tesla.Env.t}
  def rest_v10_change_order_packages_post(connection, procore_company_id, rest_v10_change_order_packages_post_request, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {201, %ProcoreV1API.Model.RestV10ChangeOrderPackagesPost201Response{}},
      {400, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {403, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}}
    ])
  end
