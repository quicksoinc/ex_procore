...
defmodule ProcoreV1API.Api.AuthenticationOAuth20Authentication do
  @moduledoc """
  ...
  """
  @spec oauth_authorize_get(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, nil} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec oauth_revoke_post(Tesla.Env.client, integer(), ProcoreV1API.Model.OauthRevokePostRequest.t, keyword()) :: {:ok, Map.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:ok, ProcoreV1API.Model.OauthTokenInfoGet200Response.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec oauth_token_info_get(Tesla.Env.client, keyword()) :: {:ok, ProcoreV1API.Model.OauthTokenInfoGet200Response.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def oauth_token_info_get(connection, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %ProcoreV1API.Model.OauthTokenInfoGet200Response{}},
      {:default, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}}
    ])
  end
  ...
  - `{:ok, ProcoreV1API.Model.OauthTokenPost200Response.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec oauth_token_post(Tesla.Env.client, ProcoreV1API.Model.OauthTokenPostRequest.t, keyword()) :: {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreV1API.Model.OauthTokenPost200Response.t} | {:error, Tesla.Env.t}
  def oauth_token_post(connection, oauth_token_post_request, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %ProcoreV1API.Model.OauthTokenPost200Response{}},
      {:default, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}}
    ])
  end
end
