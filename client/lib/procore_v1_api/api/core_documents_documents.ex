...
defmodule ProcoreV1API.Api.CoreDocumentsDocuments do
  @moduledoc """
  ...
  """
  @spec rest_v10_companies_company_id_documents_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, list(ProcoreV1API.Model.ExampleOfAFolderThatIsAFile.t)} | {:error, Tesla.Env.t}
  def rest_v10_companies_company_id_documents_get(connection, procore_company_id, company_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreV1API.Model.ExampleOfAFolderThatIsAFile{}]},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_documents_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, list(ProcoreV1API.Model.ExampleOfAFolderThatIsAFile.t)} | {:error, Tesla.Env.t}
