...
defmodule ProcoreV1API.Api.ProjectManagementDocumentMarkupDocumentMarkup do
  @moduledoc """
  ...
  - `{:ok, ProcoreV1API.Model.RestV10DocumentMarkupDownloadablePdfsFindOrCreatePost200Response.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_document_markup_downloadable_pdfs_find_or_create_post(Tesla.Env.client, integer(), ProcoreV1API.Model.RestV10DocumentMarkupDownloadablePdfsFindOrCreatePostRequest.t, keyword()) :: {:ok, ProcoreV1API.Model.RestV10DocumentMarkupDownloadablePdfsFindOrCreatePost202Response.t} | {:ok, ProcoreV1API.Model.RestV10DocumentMarkupDownloadablePdfsFindOrCreatePost409Response.t} | {:ok, ProcoreV1API.Model.RestV10DocumentMarkupDownloadablePdfsFindOrCreatePost200Response.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_document_markup_downloadable_pdfs_find_or_create_post(connection, procore_company_id, rest_v10_document_markup_downloadable_pdfs_find_or_create_post_request, opts \\ []) do
    ...
    |> evaluate_response([
      {200, %ProcoreV1API.Model.RestV10DocumentMarkupDownloadablePdfsFindOrCreatePost200Response{}},
      {202, %ProcoreV1API.Model.RestV10DocumentMarkupDownloadablePdfsFindOrCreatePost202Response{}},
      {400, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {403, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {404, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {409, %ProcoreV1API.Model.RestV10DocumentMarkupDownloadablePdfsFindOrCreatePost409Response{}},
