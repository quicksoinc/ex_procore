...
defmodule ProcoreV1API.Api.UtilitiesWebhooksDeliveries do
  @moduledoc """
  ...
  """
  @spec rest_v10_webhooks_hooks_hook_id_deliveries_get(Tesla.Env.client, integer(), integer(), integer(), integer(), keyword()) :: {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, list(ProcoreV1API.Model.WebhooksDelivery.t)} | {:error, Tesla.Env.t}
  def rest_v10_webhooks_hooks_hook_id_deliveries_get(connection, procore_company_id, hook_id, company_id, project_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreV1API.Model.WebhooksDelivery{}]},
