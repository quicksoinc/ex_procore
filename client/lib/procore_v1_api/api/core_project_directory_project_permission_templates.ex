...
defmodule ProcoreV1API.Api.CoreProjectDirectoryProjectPermissionTemplates do
  @moduledoc """
  ...
  """
  @spec rest_v10_projects_project_id_permission_templates_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, list(ProcoreV1API.Model.RestV10ProjectsProjectIdPermissionTemplatesGet200ResponseInner.t)} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_projects_project_id_permission_templates_get(connection, procore_company_id, project_id, opts \\ []) do
    optional_params = %{
