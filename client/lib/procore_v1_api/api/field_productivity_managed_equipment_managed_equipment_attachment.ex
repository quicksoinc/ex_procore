...
defmodule ProcoreV1API.Api.FieldProductivityManagedEquipmentManagedEquipmentAttachment do
  @moduledoc """
  ...
  """
  @spec rest_v10_companies_company_id_managed_equipment_id_managed_equipment_attachments_bulk_destroy_delete(Tesla.Env.client, integer(), integer(), integer(), ProcoreV1API.Model.RestV10CompaniesCompanyIdManagedEquipmentIdManagedEquipmentAttachmentsBulkDestroyDeleteRequest.t, keyword()) :: {:ok, list(ProcoreV1API.Model.ManagedEquipmentAttachment.t)} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_companies_company_id_managed_equipment_id_managed_equipment_attachments_bulk_destroy_delete(connection, procore_company_id, company_id, id, rest_v10_companies_company_id_managed_equipment_id_managed_equipment_attachments_bulk_destroy_delete_request, _opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreV1API.Model.ManagedEquipmentAttachment{}]},
