...
defmodule ProcoreV1API.Api.CoreProjectDirectoryProjectPeople do
  @moduledoc """
  ...
  """
  @spec rest_v10_projects_project_id_people_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, list(ProcoreV1API.Model.ProjectPerson1.t)} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:ok, ProcoreV1API.Model.ProjectPerson1.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_people_id_patch(Tesla.Env.client, integer(), integer(), integer(), ProcoreV1API.Model.ProjectPersonBody.t, keyword()) :: {:ok, ProcoreV1API.Model.ProjectPerson1.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_people_post(Tesla.Env.client, integer(), integer(), ProcoreV1API.Model.ProjectPersonBody.t, keyword()) :: {:ok, ProcoreV1API.Model.ProjectPerson1.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_projects_project_id_people_post(connection, procore_company_id, project_id, project_person_body, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {201, %ProcoreV1API.Model.ProjectPerson1{}},
      {400, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {401, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {403, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}}
    ])
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v11_projects_project_id_people_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, list(ProcoreV1API.Model.RestV11ProjectsProjectIdPeopleGet200ResponseInner.t)} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v11_projects_project_id_people_get(connection, procore_company_id, project_id, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%ProcoreV1API.Model.RestV11ProjectsProjectIdPeopleGet200ResponseInner{}]},
      {401, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {403, %ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v11_projects_project_id_people_id_patch(Tesla.Env.client, integer(), integer(), integer(), ProcoreV1API.Model.ProjectPersonBody.t, keyword()) :: {:ok, ProcoreV1API.Model.ProjectPerson1.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v11_projects_project_id_people_post(Tesla.Env.client, integer(), integer(), ProcoreV1API.Model.ProjectPersonBody.t, keyword()) :: {:ok, ProcoreV1API.Model.ProjectPerson1.t} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
