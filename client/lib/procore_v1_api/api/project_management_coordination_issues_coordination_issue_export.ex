...
defmodule ProcoreV1API.Api.ProjectManagementCoordinationIssuesCoordinationIssueExport do
  @moduledoc """
  ...
  """
  @spec rest_v10_coordination_issues_export_get(Tesla.Env.client, integer(), integer(), String.t, keyword()) :: {:ok, nil} | {:ok, ProcoreV1API.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, String.t} | {:error, Tesla.Env.t}
