...
defmodule ProcoreRestV1APIDocumentation.Api.UtilitiesWebhooksHooks do
  @moduledoc """
  ...
  """
  @spec rest_v10_webhooks_hooks_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, list(ProcoreRestV1APIDocumentation.Model.WebhooksHook.t)} | {:error, Tesla.Env.t}
  def rest_v10_webhooks_hooks_get(connection, procore_company_id, company_id, project_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreRestV1APIDocumentation.Model.WebhooksHook{}]},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_webhooks_hooks_id_delete(Tesla.Env.client, integer(), integer(), integer(), integer(), keyword()) :: {:ok, nil} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:ok, ProcoreRestV1APIDocumentation.Model.WebhooksHook.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_webhooks_hooks_id_patch(Tesla.Env.client, integer(), integer(), ProcoreRestV1APIDocumentation.Model.RestV10WebhooksHooksIdPatchRequest.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.WebhooksHook.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_webhooks_hooks_post(Tesla.Env.client, integer(), ProcoreRestV1APIDocumentation.Model.RestV10WebhooksHooksPostRequest.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.WebhooksHook.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_webhooks_hooks_post(connection, procore_company_id, rest_v10_webhooks_hooks_post_request, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {201, %ProcoreRestV1APIDocumentation.Model.WebhooksHook{}},
      {:default, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}}
    ])
  end
end
