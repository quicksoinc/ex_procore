...
defmodule ProcoreRestV1APIDocumentation.Api.ProjectManagementSubmittalsSubmittalApprovers do
  @moduledoc """
  ...
  """
  @spec rest_v10_submittal_approvers_id_patch(Tesla.Env.client, integer(), integer(), integer(), integer(), ProcoreRestV1APIDocumentation.Model.RestV10SubmittalApproversIdPatchRequest.t, keyword()) :: {:ok, list(ProcoreRestV1APIDocumentation.Model.RestV10SubmittalApproversIdPatch200ResponseInner.t)} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_submittal_approvers_id_patch(connection, procore_company_id, id, project_id, submittal_id, rest_v10_submittal_approvers_id_patch_request, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreRestV1APIDocumentation.Model.RestV10SubmittalApproversIdPatch200ResponseInner{}]},
