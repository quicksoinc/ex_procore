...
defmodule ProcoreRestV1APIDocumentation.Api.ConstructionFinancialsBudgetBudgetDetails do
  @moduledoc """
  ...
  """
  @spec rest_v10_budget_views_budget_view_id_budget_details_post(Tesla.Env.client, integer(), integer(), integer(), ProcoreRestV1APIDocumentation.Model.BudgetDetailsBody.t, keyword()) :: {:ok, list(ProcoreRestV1APIDocumentation.Model.RestV10BudgetViewsBudgetViewIdBudgetDetailsPost200ResponseInner.t)} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_budget_views_budget_view_id_budget_details_post(connection, procore_company_id, budget_view_id, project_id, budget_details_body, _opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreRestV1APIDocumentation.Model.RestV10BudgetViewsBudgetViewIdBudgetDetailsPost200ResponseInner{}]},
