...
defmodule ProcoreRestV1APIDocumentation.Api.CoreCompanyCompanyUploads do
  @moduledoc """
  ...
  """
  @spec rest_v10_companies_company_id_uploads_post(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdUploadsPost201Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_companies_company_id_uploads_post(connection, procore_company_id, company_id, opts \\ []) do
    optional_params = %{
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_companies_company_id_uploads_uuid_get(Tesla.Env.client, integer(), integer(), String.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdUploadsPost201Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_companies_company_id_uploads_uuid_get(connection, procore_company_id, company_id, uuid, _opts \\ []) do
    request =
      %{}
      |> method(:get)
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_companies_company_id_uploads_uuid_patch(Tesla.Env.client, integer(), integer(), String.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdUploadsPost201Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_companies_company_id_uploads_uuid_patch(connection, procore_company_id, company_id, uuid, opts \\ []) do
    optional_params = %{
      :body => :body
    }
