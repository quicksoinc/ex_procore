...
defmodule ProcoreRestV1APIDocumentation.Api.ProjectManagementModelsBIMPropertyFileProperties do
  @moduledoc """
  ...
  """
  @spec rest_v10_bim_property_files_id_properties_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, list(ProcoreRestV1APIDocumentation.Model.RestV10BimPropertyFilesIdPropertiesGet200ResponseInner.t)} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
