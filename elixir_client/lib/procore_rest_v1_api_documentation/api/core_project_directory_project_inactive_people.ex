...
defmodule ProcoreRestV1APIDocumentation.Api.CoreProjectDirectoryProjectInactivePeople do
  @moduledoc """
  ...
  """
  @spec rest_v10_projects_project_id_people_inactive_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, list(ProcoreRestV1APIDocumentation.Model.ProjectPerson1.t)} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
