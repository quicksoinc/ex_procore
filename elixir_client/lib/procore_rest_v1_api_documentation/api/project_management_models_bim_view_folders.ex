...
defmodule ProcoreRestV1APIDocumentation.Api.ProjectManagementModelsBIMViewFolders do
  @moduledoc """
  ...
  """
  @spec rest_v10_bim_view_folders_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, list(ProcoreRestV1APIDocumentation.Model.RestV10NestedBimViewFoldersPost200Response.t)} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
