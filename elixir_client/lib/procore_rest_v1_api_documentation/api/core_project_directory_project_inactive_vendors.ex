...
defmodule ProcoreRestV1APIDocumentation.Api.CoreProjectDirectoryProjectInactiveVendors do
  @moduledoc """
  ...
  def rest_v10_projects_project_id_vendors_inactive_get(connection, procore_company_id, project_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdVendorsInactiveGet200ResponseInner{}]},
