...
defmodule ProcoreRestV1APIDocumentation.Api.ProjectManagementDailyLogDailyLogClones do
  @moduledoc """
  ...
  """
  @spec rest_v10_projects_project_id_daily_logs_clones_post(Tesla.Env.client, integer(), integer(), ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdDailyLogsClonesPostRequest.t, keyword()) :: {:ok, nil} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdDailyLogsClonesPost201Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_projects_project_id_daily_logs_clones_post(connection, procore_company_id, project_id, rest_v10_projects_project_id_daily_logs_clones_post_request, opts \\ []) do
    ...
    |> evaluate_response([
      {200, false},
      {201, %ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdDailyLogsClonesPost201Response{}},
