...
defmodule ProcoreRestV1APIDocumentation.Api.CoreCompanyDirectoryCompanyInactivePeople do
  @moduledoc """
  ...
  """
  @spec rest_v10_companies_company_id_people_inactive_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, list(ProcoreRestV1APIDocumentation.Model.CompanyPerson.t)} | {:error, Tesla.Env.t}
  def rest_v10_companies_company_id_people_inactive_get(connection, procore_company_id, company_id, opts \\ []) do
    optional_params = %{
      :page => :query,
      :per_page => :query,
