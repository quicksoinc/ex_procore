...
defmodule ProcoreRestV1APIDocumentation.Api.ProjectManagementCoordinationIssuesCoordinationIssueRecycleBin do
  @moduledoc """
  ...
  """
  @spec rest_v10_coordination_issues_recycle_bin_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, list(ProcoreRestV1APIDocumentation.Model.RestV10CoordinationIssuesGet200ResponseInner.t)} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_coordination_issues_recycle_bin_get(connection, procore_company_id, project_id, opts \\ []) do
    optional_params = %{
      :page => :query,
      :per_page => :query,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_coordination_issues_recycle_bin_id_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CoordinationIssuesGet200ResponseInner.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_coordination_issues_recycle_bin_id_get(connection, procore_company_id, id, project_id, opts \\ []) do
    optional_params = %{
      :view => :query
    }
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_coordination_issues_recycle_bin_id_patch(Tesla.Env.client, integer(), integer(), ProcoreRestV1APIDocumentation.Model.RestV10CoordinationIssuesRecycleBinIdPatchRequest.t, keyword()) :: {:ok, nil} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_coordination_issues_recycle_bin_id_patch(connection, procore_company_id, id, rest_v10_coordination_issues_recycle_bin_id_patch_request, _opts \\ []) do
    request =
      %{}
      |> method(:patch)
      |> url("/rest/v1.0/coordination_issues/recycle_bin/#{id}")
