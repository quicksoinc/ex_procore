...
defmodule ProcoreRestV1APIDocumentation.Api.ProjectManagementModelsBIMModelRevisionObjects do
  @moduledoc """
  ...
  """
  @spec rest_v10_bim_model_revisions_id_objects_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, list(ProcoreRestV1APIDocumentation.Model.RestV10BimPropertyFilesIdObjectsGet200ResponseInner.t)} | {:error, Tesla.Env.t}
  def rest_v10_bim_model_revisions_id_objects_get(connection, procore_company_id, id, project_id, opts \\ []) do
    optional_params = %{
      :page => :query,
      :per_page => :query,
      :"filters[id]" => :query,
    ...
    |> evaluate_response([
      {200, [%ProcoreRestV1APIDocumentation.Model.RestV10BimPropertyFilesIdObjectsGet200ResponseInner{}]},
