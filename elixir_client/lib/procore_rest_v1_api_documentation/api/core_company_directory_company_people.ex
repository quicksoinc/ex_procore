...
defmodule ProcoreRestV1APIDocumentation.Api.CoreCompanyDirectoryCompanyPeople do
  @moduledoc """
  ...
  """
  @spec rest_v10_companies_company_id_people_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, list(ProcoreRestV1APIDocumentation.Model.CompanyPerson.t)} | {:error, Tesla.Env.t}
  def rest_v10_companies_company_id_people_get(connection, procore_company_id, company_id, opts \\ []) do
    optional_params = %{
      :page => :query,
      :per_page => :query,
    ...
    |> evaluate_response([
      {200, [%ProcoreRestV1APIDocumentation.Model.CompanyPerson{}]},
  ...
  - `{:ok, ProcoreRestV1APIDocumentation.Model.CompanyPerson.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_companies_company_id_people_id_patch(Tesla.Env.client, integer(), integer(), integer(), ProcoreRestV1APIDocumentation.Model.CompanyPersonBody.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.CompanyPerson.t} | {:error, Tesla.Env.t}
  def rest_v10_companies_company_id_people_id_patch(connection, procore_company_id, company_id, id, company_person_body, _opts \\ []) do
    request =
      %{}
      |> method(:patch)
