...
defmodule ProcoreRestV1APIDocumentation.Api.ConstructionFinancialsBudgetBudgetViewSummaryRows do
  @moduledoc """
  ...
  """
  @spec rest_v10_budget_views_budget_view_id_summary_rows_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, list(ProcoreRestV1APIDocumentation.Model.RestV10BudgetViewsBudgetViewIdSummaryRowsGet200ResponseInner.t)} | {:error, Tesla.Env.t}
  def rest_v10_budget_views_budget_view_id_summary_rows_get(connection, procore_company_id, budget_view_id, project_id, opts \\ []) do
    optional_params = %{
      :page => :query,
      :per_page => :query,
      :"biller[]" => :query,
    ...
    |> evaluate_response([
      {200, [%ProcoreRestV1APIDocumentation.Model.RestV10BudgetViewsBudgetViewIdSummaryRowsGet200ResponseInner{}]},
