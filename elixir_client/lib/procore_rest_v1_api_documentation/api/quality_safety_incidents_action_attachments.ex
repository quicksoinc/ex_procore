...
defmodule ProcoreRestV1APIDocumentation.Api.QualitySafetyIncidentsActionAttachments do
  @moduledoc """
  ...
  """
  @spec rest_v10_projects_project_id_incidents_actions_action_id_attachments_post(Tesla.Env.client, integer(), integer(), integer(), String.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.IncidentAttachment1.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
