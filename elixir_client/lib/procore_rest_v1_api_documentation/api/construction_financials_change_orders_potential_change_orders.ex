...
defmodule ProcoreRestV1APIDocumentation.Api.ConstructionFinancialsChangeOrdersPotentialChangeOrders do
  @moduledoc """
  ...
  """
  @spec rest_v10_potential_change_orders_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, list(ProcoreRestV1APIDocumentation.Model.RestV10PotentialChangeOrdersGet200ResponseInner.t)} | {:error, Tesla.Env.t}
  def rest_v10_potential_change_orders_get(connection, procore_company_id, project_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreRestV1APIDocumentation.Model.RestV10PotentialChangeOrdersGet200ResponseInner{}]},
  ...
  def rest_v10_potential_change_orders_id_get(connection, procore_company_id, id, project_id, contract_id, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %ProcoreRestV1APIDocumentation.Model.ArrayOfPotentialChangeOrdersEntitiesInner{}},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_potential_change_orders_id_patch(Tesla.Env.client, integer(), integer(), ProcoreRestV1APIDocumentation.Model.RestV10PotentialChangeOrdersIdPatchRequest.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.ArrayOfPotentialChangeOrdersEntitiesInner.t} | {:error, Tesla.Env.t}
  ...
  - `{:ok, ProcoreRestV1APIDocumentation.Model.RestV10PotentialChangeOrdersPost201Response.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_potential_change_orders_post(Tesla.Env.client, integer(), ProcoreRestV1APIDocumentation.Model.RestV10PotentialChangeOrdersPostRequest.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10PotentialChangeOrdersPost201Response.t} | {:error, Tesla.Env.t}
  def rest_v10_potential_change_orders_post(connection, procore_company_id, rest_v10_potential_change_orders_post_request, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {201, %ProcoreRestV1APIDocumentation.Model.RestV10PotentialChangeOrdersPost201Response{}},
      {400, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {403, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}}
    ])
  end
  ...
  def rest_v10_potential_change_orders_potential_change_order_id_line_items_get(connection, procore_company_id, potential_change_order_id, project_id, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%ProcoreRestV1APIDocumentation.Model.Default{}]},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_potential_change_orders_potential_change_order_id_line_items_id_delete(Tesla.Env.client, integer(), integer(), integer(), integer(), keyword()) :: {:ok, nil} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:ok, ProcoreRestV1APIDocumentation.Model.Default.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_potential_change_orders_potential_change_order_id_line_items_id_get(Tesla.Env.client, integer(), integer(), integer(), integer(), keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.Default.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_potential_change_orders_potential_change_order_id_line_items_id_patch(Tesla.Env.client, integer(), integer(), integer(), ProcoreRestV1APIDocumentation.Model.Body3.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.Default.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_potential_change_orders_potential_change_order_id_line_items_post(Tesla.Env.client, integer(), integer(), ProcoreRestV1APIDocumentation.Model.Body3.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.Default.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_potential_change_orders_potential_change_order_id_line_items_post(connection, procore_company_id, potential_change_order_id, body3, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {201, %ProcoreRestV1APIDocumentation.Model.Default{}},
      {400, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {401, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {403, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {:default, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}}
  ...
  - `{:ok, ProcoreRestV1APIDocumentation.Model.ArrayOfPotentialChangeOrderLineItems.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_potential_change_orders_potential_change_order_id_line_items_sync_patch(Tesla.Env.client, integer(), integer(), integer(), ProcoreRestV1APIDocumentation.Model.LineItemSyncBody.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.ArrayOfPotentialChangeOrderLineItems.t} | {:error, Tesla.Env.t}
  def rest_v10_potential_change_orders_potential_change_order_id_line_items_sync_patch(connection, procore_company_id, project_id, potential_change_order_id, line_item_sync_body, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %ProcoreRestV1APIDocumentation.Model.ArrayOfPotentialChangeOrderLineItems{}},
      {400, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {401, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {403, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {:default, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}}
  ...
  - `{:ok, ProcoreRestV1APIDocumentation.Model.ArrayOfPotentialChangeOrders.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_potential_change_orders_sync_patch(Tesla.Env.client, integer(), integer(), integer(), ProcoreRestV1APIDocumentation.Model.PotentialChangeOrderBody.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.ArrayOfPotentialChangeOrders.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdProjectsProjectIdTaskItemCommentsPost403Response.t} | {:error, Tesla.Env.t}
  def rest_v10_potential_change_orders_sync_patch(connection, procore_company_id, project_id, contract_id, potential_change_order_body, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %ProcoreRestV1APIDocumentation.Model.ArrayOfPotentialChangeOrders{}},
      {401, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdProjectsProjectIdTaskItemCommentsPost403Response{}},
