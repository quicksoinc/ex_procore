...
defmodule ProcoreRestV1APIDocumentation.Api.AuthenticationUtilitiesMe do
  @moduledoc """
  ...
  - `{:ok, ProcoreRestV1APIDocumentation.Model.RestV10MeGet200Response.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_me_get(Tesla.Env.client, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10MeGet200Response.t} | {:error, Tesla.Env.t}
  def rest_v10_me_get(connection, opts \\ []) do
    ...
    |> evaluate_response([
      {200, %ProcoreRestV1APIDocumentation.Model.RestV10MeGet200Response{}},
