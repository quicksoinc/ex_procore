...
defmodule ProcoreRestV1APIDocumentation.Api.QualitySafetyActionPlansActionPlanParties do
  @moduledoc """
  ...
  def rest_v10_projects_project_id_action_plans_parties_get(connection, procore_company_id, project_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdActionPlansPartiesGet200ResponseInner{}]},
