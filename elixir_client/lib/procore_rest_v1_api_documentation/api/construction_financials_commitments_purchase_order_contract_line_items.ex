...
defmodule ProcoreRestV1APIDocumentation.Api.ConstructionFinancialsCommitmentsPurchaseOrderContractLineItems do
  @moduledoc """
  ...
  """
  @spec rest_v10_purchase_order_contracts_purchase_order_contract_id_line_items_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, list(ProcoreRestV1APIDocumentation.Model.RestV10WorkOrderContractsWorkOrderContractIdLineItemsGet200ResponseInner.t)} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_purchase_order_contracts_purchase_order_contract_id_line_items_get(connection, procore_company_id, purchase_order_contract_id, project_id, opts \\ []) do
    optional_params = %{
      :page => :query,
      :per_page => :query,
      :"filters[id]" => :query,
    ...
    |> evaluate_response([
      {200, [%ProcoreRestV1APIDocumentation.Model.RestV10WorkOrderContractsWorkOrderContractIdLineItemsGet200ResponseInner{}]},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_purchase_order_contracts_purchase_order_contract_id_line_items_id_delete(Tesla.Env.client, integer(), integer(), integer(), integer(), keyword()) :: {:ok, nil} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_purchase_order_contracts_purchase_order_contract_id_line_items_id_delete(connection, procore_company_id, purchase_order_contract_id, id, project_id, _opts \\ []) do
    request =
      %{}
      |> method(:delete)
  ...
  - `{:ok, ProcoreRestV1APIDocumentation.Model.RestV10WorkOrderContractsWorkOrderContractIdLineItemsGet200ResponseInner.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_purchase_order_contracts_purchase_order_contract_id_line_items_id_get(Tesla.Env.client, integer(), integer(), integer(), integer(), keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10WorkOrderContractsWorkOrderContractIdLineItemsGet200ResponseInner.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_purchase_order_contracts_purchase_order_contract_id_line_items_id_get(connection, procore_company_id, purchase_order_contract_id, id, project_id, opts \\ []) do
    optional_params = %{
      :view => :query
    }
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_purchase_order_contracts_purchase_order_contract_id_line_items_id_patch(Tesla.Env.client, integer(), integer(), integer(), ProcoreRestV1APIDocumentation.Model.Body3.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.Default.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_purchase_order_contracts_purchase_order_contract_id_line_items_id_patch(connection, procore_company_id, purchase_order_contract_id, id, body3, _opts \\ []) do
    request =
      %{}
      |> method(:patch)
      |> url("/rest/v1.0/purchase_order_contracts/#{purchase_order_contract_id}/line_items/#{id}")
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_purchase_order_contracts_purchase_order_contract_id_line_items_post(Tesla.Env.client, integer(), integer(), ProcoreRestV1APIDocumentation.Model.Body3.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.Default.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_purchase_order_contracts_purchase_order_contract_id_line_items_post(connection, procore_company_id, purchase_order_contract_id, body3, _opts \\ []) do
    request =
      %{}
      |> method(:post)
      |> url("/rest/v1.0/purchase_order_contracts/#{purchase_order_contract_id}/line_items")
  ...
  - `{:ok, ProcoreRestV1APIDocumentation.Model.RestV10WorkOrderContractsWorkOrderContractIdLineItemsSyncPatch200Response.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_purchase_order_contracts_purchase_order_contract_id_line_items_sync_patch(Tesla.Env.client, integer(), integer(), integer(), ProcoreRestV1APIDocumentation.Model.LineItemSyncBody.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10WorkOrderContractsWorkOrderContractIdLineItemsSyncPatch200Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_purchase_order_contracts_purchase_order_contract_id_line_items_sync_patch(connection, procore_company_id, purchase_order_contract_id, project_id, line_item_sync_body, _opts \\ []) do
    request =
      %{}
      |> method(:patch)
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %ProcoreRestV1APIDocumentation.Model.RestV10WorkOrderContractsWorkOrderContractIdLineItemsSyncPatch200Response{}},
      {400, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {401, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {403, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
