...
defmodule ProcoreRestV1APIDocumentation.Api.ConstructionFinancialsChangeOrdersChangeOrderRequests do
  @moduledoc """
  ...
  """
  @spec rest_v10_change_order_requests_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, list(ProcoreRestV1APIDocumentation.Model.RestV10ChangeOrderRequestsGet200ResponseInner.t)} | {:error, Tesla.Env.t}
  def rest_v10_change_order_requests_get(connection, procore_company_id, project_id, contract_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreRestV1APIDocumentation.Model.RestV10ChangeOrderRequestsGet200ResponseInner{}]},
  ...
  - `{:ok, ProcoreRestV1APIDocumentation.Model.ArrayOfChangeOrderRequestsEntitiesInner.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_change_order_requests_id_get(Tesla.Env.client, integer(), integer(), integer(), integer(), keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.ArrayOfChangeOrderRequestsEntitiesInner.t} | {:error, Tesla.Env.t}
  def rest_v10_change_order_requests_id_get(connection, procore_company_id, id, project_id, contract_id, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %ProcoreRestV1APIDocumentation.Model.ArrayOfChangeOrderRequestsEntitiesInner{}},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_change_order_requests_id_patch(Tesla.Env.client, integer(), integer(), ProcoreRestV1APIDocumentation.Model.RestV10ChangeOrderRequestsPostRequest.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.ArrayOfChangeOrderRequestsEntitiesInner.t} | {:error, Tesla.Env.t}
  ...
  - `{:ok, ProcoreRestV1APIDocumentation.Model.RestV10ChangeOrderRequestsPost201Response.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_change_order_requests_post(Tesla.Env.client, integer(), ProcoreRestV1APIDocumentation.Model.RestV10ChangeOrderRequestsPostRequest.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10ChangeOrderRequestsPost201Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_change_order_requests_post(connection, procore_company_id, rest_v10_change_order_requests_post_request, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {201, %ProcoreRestV1APIDocumentation.Model.RestV10ChangeOrderRequestsPost201Response{}},
      {400, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {403, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}}
    ])
  end
  ...
  - `{:ok, ProcoreRestV1APIDocumentation.Model.ArrayOfChangeOrderRequests.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_change_order_requests_sync_patch(Tesla.Env.client, integer(), integer(), integer(), ProcoreRestV1APIDocumentation.Model.ChangeOrderRequestSync.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdProjectsProjectIdTaskItemCommentsPost403Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.ArrayOfChangeOrderRequests.t} | {:error, Tesla.Env.t}
  def rest_v10_change_order_requests_sync_patch(connection, procore_company_id, project_id, contract_id, change_order_request_sync, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %ProcoreRestV1APIDocumentation.Model.ArrayOfChangeOrderRequests{}},
