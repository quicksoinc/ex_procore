...
defmodule ProcoreRestV1APIDocumentation.Api.CoreProjectDocumentsProjectDocuments do
  @moduledoc """
  ...
  def rest_v10_projects_project_id_document_custom_tags_get(connection, procore_company_id, project_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdDocumentCustomTagsGet200ResponseInner{}]},
  ...
  - `{:ok, ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdDocumentCustomTagsGet200ResponseInner.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_document_custom_tags_id_delete(Tesla.Env.client, integer(), integer(), integer(), integer(), keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdDocumentCustomTagsGet200ResponseInner.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10ProjectsIdFiltersGetDefaultResponse.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_document_custom_tags_post(Tesla.Env.client, integer(), integer(), ProcoreRestV1APIDocumentation.Model.Body38.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdDocumentCustomTagsGet200ResponseInner.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
