...
defmodule ProcoreRestV1APIDocumentation.Api.ProjectManagementModelsBIMModelRevisionViewpointBatch do
  @moduledoc """
  ...
  - `{:ok, ProcoreRestV1APIDocumentation.Model.BimModelRevisionViewpointBatchCreateResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_bim_model_revision_viewpoints_batch_post(Tesla.Env.client, integer(), ProcoreRestV1APIDocumentation.Model.Body124.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.BimModelRevisionViewpointBatchCreateResponse.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_bim_model_revision_viewpoints_batch_post(connection, procore_company_id, body124, _opts \\ []) do
    ...
    |> evaluate_response([
      {200, %ProcoreRestV1APIDocumentation.Model.BimModelRevisionViewpointBatchCreateResponse{}},
