...
defmodule ProcoreRestV1APIDocumentation.Api.FieldProductivityWorkClassificationWorkClassificationProjectLevel do
  @moduledoc """
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_work_classifications_id_patch(Tesla.Env.client, integer(), integer(), integer(), ProcoreRestV1APIDocumentation.Model.WorkClassificationBody.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdWorkClassificationsGet200ResponseInner.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_work_classifications_post(Tesla.Env.client, integer(), integer(), ProcoreRestV1APIDocumentation.Model.WorkClassificationBody.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdWorkClassificationsGet200ResponseInner.t} | {:error, Tesla.Env.t}
