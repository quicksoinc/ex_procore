...
defmodule ProcoreRestV1APIDocumentation.Api.ProjectManagementModelsBIMModelChangeHistory do
  @moduledoc """
  ...
  """
  @spec rest_v10_bim_models_id_change_history_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, list(ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdTimeAndMaterialEntriesIdChangeHistoryGet304Response.t)} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_bim_models_id_change_history_get(connection, procore_company_id, id, project_id, opts \\ []) do
    optional_params = %{
      :page => :query,
      :per_page => :query,
      :view => :query
