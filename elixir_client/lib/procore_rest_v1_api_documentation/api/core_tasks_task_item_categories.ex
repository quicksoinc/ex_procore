...
defmodule ProcoreRestV1APIDocumentation.Api.CoreTasksTaskItemCategories do
  @moduledoc """
  ...
  def rest_v10_companies_company_id_projects_project_id_task_item_categories_get(connection, procore_company_id, company_id, project_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdProjectsProjectIdTaskItemCategoriesGet200ResponseInner{}]},
