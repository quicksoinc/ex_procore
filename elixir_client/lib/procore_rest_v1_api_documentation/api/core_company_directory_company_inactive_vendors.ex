...
defmodule ProcoreRestV1APIDocumentation.Api.CoreCompanyDirectoryCompanyInactiveVendors do
  @moduledoc """
  ...
  """
  @spec rest_v10_companies_company_id_vendors_inactive_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, list(ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdVendorsInactiveGet200ResponseInner.t)} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_companies_company_id_vendors_inactive_get(connection, procore_company_id, company_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdVendorsInactiveGet200ResponseInner{}]},
