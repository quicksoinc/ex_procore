...
defmodule ProcoreRestV1APIDocumentation.Api.ProjectManagementModelsBIMViewpointAssociations do
  @moduledoc """
  ...
  """
  @spec rest_v10_bim_viewpoints_bim_viewpoint_id_associations_delete(Tesla.Env.client, integer(), integer(), integer(), integer(), String.t, keyword()) :: {:ok, nil} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_bim_viewpoints_bim_viewpoint_id_associations_post(Tesla.Env.client, integer(), integer(), ProcoreRestV1APIDocumentation.Model.Body115.t, keyword()) :: {:ok, nil} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
