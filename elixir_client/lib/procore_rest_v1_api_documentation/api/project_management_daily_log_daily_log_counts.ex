...
defmodule ProcoreRestV1APIDocumentation.Api.ProjectManagementDailyLogDailyLogCounts do
  @moduledoc """
  ...
  """
  @spec rest_v11_projects_project_id_daily_logs_counts_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, list(ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdDailyLogsCountGet200ResponseInner.t)} | {:error, Tesla.Env.t}
  def rest_v11_projects_project_id_daily_logs_counts_get(connection, procore_company_id, project_id, opts \\ []) do
    optional_params = %{
      :log_date => :query,
      :start_date => :query,
      :end_date => :query,
    ...
    |> evaluate_response([
      {200, [%ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdDailyLogsCountGet200ResponseInner{}]},
