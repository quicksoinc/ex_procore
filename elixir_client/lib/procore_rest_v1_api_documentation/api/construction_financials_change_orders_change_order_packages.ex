...
defmodule ProcoreRestV1APIDocumentation.Api.ConstructionFinancialsChangeOrdersChangeOrderPackages do
  @moduledoc """
  ...
  """
  @spec rest_v10_change_order_packages_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, list(ProcoreRestV1APIDocumentation.Model.RestV10ChangeOrderPackagesGet200ResponseInner.t)} | {:error, Tesla.Env.t}
  def rest_v10_change_order_packages_get(connection, procore_company_id, project_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreRestV1APIDocumentation.Model.RestV10ChangeOrderPackagesGet200ResponseInner{}]},
  ...
  - `{:ok, ProcoreRestV1APIDocumentation.Model.RestV10ChangeOrderPackagesIdGet200Response.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_change_order_packages_id_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10ChangeOrderPackagesIdGet200Response.t} | {:error, Tesla.Env.t}
  def rest_v10_change_order_packages_id_get(connection, procore_company_id, id, project_id, opts \\ []) do
    optional_params = %{
      :contract_id => :query
    }
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %ProcoreRestV1APIDocumentation.Model.RestV10ChangeOrderPackagesIdGet200Response{}},
      {401, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {403, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {404, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}}
    ])
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_change_order_packages_id_patch(Tesla.Env.client, integer(), integer(), ProcoreRestV1APIDocumentation.Model.RestV10ChangeOrderPackagesIdPatchRequest.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10ChangeOrderPackagesIdGet200Response.t} | {:error, Tesla.Env.t}
  def rest_v10_change_order_packages_id_patch(connection, procore_company_id, id, rest_v10_change_order_packages_id_patch_request, _opts \\ []) do
    request =
      %{}
      |> method(:patch)
      |> url("/rest/v1.0/change_order_packages/#{id}")
  ...
  - `{:ok, ProcoreRestV1APIDocumentation.Model.RestV10ChangeOrderPackagesPost201Response.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_change_order_packages_post(Tesla.Env.client, integer(), ProcoreRestV1APIDocumentation.Model.RestV10ChangeOrderPackagesPostRequest.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10ChangeOrderPackagesPost201Response.t} | {:error, Tesla.Env.t}
  def rest_v10_change_order_packages_post(connection, procore_company_id, rest_v10_change_order_packages_post_request, _opts \\ []) do
    request =
      %{}
      |> method(:post)
      |> url("/rest/v1.0/change_order_packages")
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {201, %ProcoreRestV1APIDocumentation.Model.RestV10ChangeOrderPackagesPost201Response{}},
      {400, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {403, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}}
    ])
  end
