...
defmodule ProcoreRestV1APIDocumentation.Api.QualitySafetyIncidentsProjectIncidentConfiguration do
  @moduledoc """
  ...
  - `{:ok, ProcoreRestV1APIDocumentation.Model.ProjectIncidentConfiguration.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_incidents_configuration_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.ProjectIncidentConfiguration.t} | {:error, Tesla.Env.t}
  def rest_v10_projects_project_id_incidents_configuration_get(connection, procore_company_id, project_id, _opts \\ []) do
    ...
    |> evaluate_response([
      {200, %ProcoreRestV1APIDocumentation.Model.ProjectIncidentConfiguration{}},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_incidents_configuration_patch(Tesla.Env.client, integer(), integer(), ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdIncidentsConfigurationPatchRequest.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.ProjectIncidentConfiguration.t} | {:error, Tesla.Env.t}
