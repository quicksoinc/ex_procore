...
defmodule ProcoreRestV1APIDocumentation.Api.QualitySafetyInspectionsChecklistItemTypes do
  @moduledoc """
  ...
  """
  @spec rest_v10_checklist_item_types_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, list(ProcoreRestV1APIDocumentation.Model.ChecklistItemType.t)} | {:error, Tesla.Env.t}
  def rest_v10_checklist_item_types_get(connection, procore_company_id, project_id, company_id, opts \\ []) do
    optional_params = %{
      :page => :query,
      :per_page => :query
    }
    ...
    |> evaluate_response([
      {200, [%ProcoreRestV1APIDocumentation.Model.ChecklistItemType{}]},
  ...
  - `{:ok, ProcoreRestV1APIDocumentation.Model.ChecklistItemType.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_checklist_item_types_id_get(Tesla.Env.client, integer(), integer(), integer(), integer(), keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.ChecklistItemType.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_checklist_item_types_id_get(connection, procore_company_id, project_id, company_id, id, _opts \\ []) do
    request =
      %{}
      |> method(:get)
