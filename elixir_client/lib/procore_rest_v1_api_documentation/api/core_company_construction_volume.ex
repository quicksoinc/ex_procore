...
defmodule ProcoreRestV1APIDocumentation.Api.CoreCompanyConstructionVolume do
  @moduledoc """
  ...
  """
  @spec rest_v10_companies_company_id_construction_volume_urgent_error_post(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, Map.t} | {:error, Tesla.Env.t}
