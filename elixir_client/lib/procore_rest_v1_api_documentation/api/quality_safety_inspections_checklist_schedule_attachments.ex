...
defmodule ProcoreRestV1APIDocumentation.Api.QualitySafetyInspectionsChecklistScheduleAttachments do
  @moduledoc """
  ...
  """
  @spec rest_v10_projects_project_id_checklist_schedules_schedule_id_attachments_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, list(ProcoreRestV1APIDocumentation.Model.ChecklistScheduleAttachment.t)} | {:error, Tesla.Env.t}
  def rest_v10_projects_project_id_checklist_schedules_schedule_id_attachments_get(connection, procore_company_id, project_id, schedule_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreRestV1APIDocumentation.Model.ChecklistScheduleAttachment{}]},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_checklist_schedules_schedule_id_attachments_id_delete(Tesla.Env.client, integer(), integer(), integer(), integer(), keyword()) :: {:ok, nil} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdChecklistSchedulesScheduleIdAttachmentsIdDelete400Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10WorkOrderContractsWorkOrderContractIdSubcontractorScheduleOfValuesStatusPatch404Response.t} | {:error, Tesla.Env.t}
  def rest_v10_projects_project_id_checklist_schedules_schedule_id_attachments_id_delete(connection, procore_company_id, project_id, schedule_id, id, _opts \\ []) do
    ...
    |> evaluate_response([
      {204, false},
      {400, %ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdChecklistSchedulesScheduleIdAttachmentsIdDelete400Response{}},
      {401, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {403, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
