...
defmodule ProcoreRestV1APIDocumentation.Api.ProjectManagementDrawingsDrawingRevisionEmails do
  @moduledoc """
  ...
  """
  @spec rest_v10_projects_project_id_drawing_revision_emails_id_send_email_post(Tesla.Env.client, integer(), integer(), integer(), ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdSpecificationSectionRevisionEmailsIdSendEmailPostRequest.t, keyword()) :: {:ok, nil} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_projects_project_id_drawing_revision_emails_id_send_email_post(connection, procore_company_id, project_id, id, rest_v10_projects_project_id_specification_section_revision_emails_id_send_email_post_request, _opts \\ []) do
    request =
      %{}
      |> method(:post)
