...
defmodule ProcoreRestV1APIDocumentation.Api.FieldProductivityBudgetedProductionQuantitiesBudgetedProductionQuantities do
  @moduledoc """
  ...
  """
  @spec rest_v10_projects_project_id_budgeted_production_quantities_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, list(ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdBudgetedProductionQuantitiesGet200ResponseInner.t)} | {:error, Tesla.Env.t}
  def rest_v10_projects_project_id_budgeted_production_quantities_get(connection, procore_company_id, project_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdBudgetedProductionQuantitiesGet200ResponseInner{}]}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_budgeted_production_quantities_id_delete(Tesla.Env.client, integer(), integer(), integer(), ProcoreRestV1APIDocumentation.Model.BudgetedProductionQuantityBody.t, keyword()) :: {:ok, nil} | {:error, Tesla.Env.t}
  ...
  - `{:ok, ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdBudgetedProductionQuantitiesGet200ResponseInner.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_budgeted_production_quantities_id_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdBudgetedProductionQuantitiesGet200ResponseInner.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_budgeted_production_quantities_id_patch(Tesla.Env.client, integer(), integer(), integer(), ProcoreRestV1APIDocumentation.Model.BudgetedProductionQuantityBody.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdBudgetedProductionQuantitiesGet200ResponseInner.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_budgeted_production_quantities_post(Tesla.Env.client, integer(), integer(), ProcoreRestV1APIDocumentation.Model.BudgetedProductionQuantityBody.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdBudgetedProductionQuantitiesGet200ResponseInner.t} | {:error, Tesla.Env.t}
  def rest_v10_projects_project_id_budgeted_production_quantities_post(connection, procore_company_id, project_id, budgeted_production_quantity_body, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {201, %ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdBudgetedProductionQuantitiesGet200ResponseInner{}},
      {422, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {:default, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}}
    ])
  end
