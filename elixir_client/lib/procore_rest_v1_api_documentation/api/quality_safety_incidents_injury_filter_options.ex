...
defmodule ProcoreRestV1APIDocumentation.Api.QualitySafetyIncidentsInjuryFilterOptions do
  @moduledoc """
  ...
  def rest_v10_projects_project_id_incidents_injuries_filter_options_affected_body_parts_get(connection, procore_company_id, project_id, _opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdIncidentsInjuriesFilterOptionsAffectedBodyPartsGet200ResponseInner{}]},
