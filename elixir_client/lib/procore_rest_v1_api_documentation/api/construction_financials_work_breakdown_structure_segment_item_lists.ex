...
defmodule ProcoreRestV1APIDocumentation.Api.ConstructionFinancialsWorkBreakdownStructureSegmentItemLists do
  @moduledoc """
  ...
  def rest_v10_companies_company_id_work_breakdown_structure_segments_segment_id_lists_get(connection, procore_company_id, company_id, segment_id, _opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkBreakdownStructureSegmentsSegmentIdListsGet200ResponseInner{}]},
