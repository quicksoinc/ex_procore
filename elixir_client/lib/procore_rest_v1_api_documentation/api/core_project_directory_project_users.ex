...
defmodule ProcoreRestV1APIDocumentation.Api.CoreProjectDirectoryProjectUsers do
  @moduledoc """
  ...
  - `{:ok, [%ProjectUser{}, ...]}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_users_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, list(ProcoreRestV1APIDocumentation.Model.ProjectUser.t)} | {:error, Tesla.Env.t}
  def rest_v10_projects_project_id_users_get(connection, procore_company_id, project_id, opts \\ []) do
    optional_params = %{
      :page => :query,
      :per_page => :query,
    ...
    |> evaluate_response([
      {200, [%ProcoreRestV1APIDocumentation.Model.ProjectUser{}]},
  ...
  - `{:ok, ProcoreRestV1APIDocumentation.Model.ProjectUser.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_users_id_actions_add_post(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.ProjectUser.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_projects_project_id_users_id_actions_add_post(connection, procore_company_id, project_id, id, opts \\ []) do
    optional_params = %{
      :body => :body
    }
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {201, %ProcoreRestV1APIDocumentation.Model.ProjectUser{}},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_users_id_actions_remove_delete(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, nil} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_projects_project_id_users_id_actions_remove_delete(connection, procore_company_id, project_id, id, _opts \\ []) do
    request =
      %{}
      |> method(:delete)
  ...
  - `{:ok, ProcoreRestV1APIDocumentation.Model.User1.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_users_id_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.User1.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_projects_project_id_users_id_get(connection, procore_company_id, project_id, id, _opts \\ []) do
    request =
      %{}
      |> method(:get)
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %ProcoreRestV1APIDocumentation.Model.User1{}},
      {401, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {403, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_users_id_patch(Tesla.Env.client, integer(), integer(), integer(), ProcoreRestV1APIDocumentation.Model.ProjectUserBody1.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.User1.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_projects_project_id_users_id_patch(connection, procore_company_id, project_id, id, project_user_body1, opts \\ []) do
    optional_params = %{
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_users_post(Tesla.Env.client, integer(), integer(), ProcoreRestV1APIDocumentation.Model.ProjectUserBody.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.User1.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_projects_project_id_users_post(connection, procore_company_id, project_id, project_user_body, opts \\ []) do
    optional_params = %{
      :run_configurable_validations => :query
    }
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {201, %ProcoreRestV1APIDocumentation.Model.User1{}},
      {400, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {401, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {403, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}}
    ])
