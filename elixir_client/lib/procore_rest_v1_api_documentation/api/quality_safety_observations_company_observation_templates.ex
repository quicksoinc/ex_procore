...
defmodule ProcoreRestV1APIDocumentation.Api.QualitySafetyObservationsCompanyObservationTemplates do
  @moduledoc """
  ...
  """
  @spec rest_v10_companies_company_id_observation_templates_bulk_update_patch(Tesla.Env.client, integer(), integer(), ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdObservationTemplatesBulkUpdatePatchRequest.t, keyword()) :: {:ok, list(ProcoreRestV1APIDocumentation.Model.CompanyObservationTemplate1.t)} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_companies_company_id_observation_templates_bulk_update_patch(connection, procore_company_id, company_id, rest_v10_companies_company_id_observation_templates_bulk_update_patch_request, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreRestV1APIDocumentation.Model.CompanyObservationTemplate1{}]},
