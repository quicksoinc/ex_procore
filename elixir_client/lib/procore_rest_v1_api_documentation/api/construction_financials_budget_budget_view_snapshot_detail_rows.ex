...
defmodule ProcoreRestV1APIDocumentation.Api.ConstructionFinancialsBudgetBudgetViewSnapshotDetailRows do
  @moduledoc """
  ...
  """
  @spec rest_v10_budget_view_snapshots_budget_view_snapshot_id_detail_rows_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, list(ProcoreRestV1APIDocumentation.Model.RestV10BudgetViewSnapshotsBudgetViewSnapshotIdDetailRowsGet200ResponseInner.t)} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_budget_view_snapshots_budget_view_snapshot_id_detail_rows_get(connection, procore_company_id, budget_view_snapshot_id, project_id, opts \\ []) do
    optional_params = %{
      :page => :query,
      :per_page => :query,
      :"biller[]" => :query,
    ...
    |> evaluate_response([
      {200, [%ProcoreRestV1APIDocumentation.Model.RestV10BudgetViewSnapshotsBudgetViewSnapshotIdDetailRowsGet200ResponseInner{}]},
