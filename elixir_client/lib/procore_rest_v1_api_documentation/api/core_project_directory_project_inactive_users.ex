...
defmodule ProcoreRestV1APIDocumentation.Api.CoreProjectDirectoryProjectInactiveUsers do
  @moduledoc """
  ...
  """
  @spec rest_v10_projects_project_id_users_inactive_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, list(ProcoreRestV1APIDocumentation.Model.InactiveUser.t)} | {:error, Tesla.Env.t}
