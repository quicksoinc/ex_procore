...
defmodule ProcoreRestV1APIDocumentation.Api.ProjectManagementProjectScheduleTaskRequestedChanges do
  @moduledoc """
  ...
  """
  @spec rest_v11_projects_project_id_schedule_requested_changes_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, list(ProcoreRestV1APIDocumentation.Model.RestV11ProjectsProjectIdScheduleRequestedChangesGet200ResponseInner.t)} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v11_projects_project_id_schedule_requested_changes_get(connection, procore_company_id, project_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreRestV1APIDocumentation.Model.RestV11ProjectsProjectIdScheduleRequestedChangesGet200ResponseInner{}]},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v11_projects_project_id_schedule_tasks_task_id_requested_changes_post(Tesla.Env.client, integer(), integer(), integer(), ProcoreRestV1APIDocumentation.Model.RestV11ProjectsProjectIdScheduleTasksTaskIdRequestedChangesPostRequest.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV11ProjectsProjectIdScheduleRequestedChangesGet200ResponseInner.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
