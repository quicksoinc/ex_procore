...
defmodule ProcoreRestV1APIDocumentation.Api.CoreCompanyDirectoryCompanyVendors do
  @moduledoc """
  ...
  """
  @spec rest_v10_vendors_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, list(ProcoreRestV1APIDocumentation.Model.RestV10VendorsGet200ResponseInner.t)} | {:error, Tesla.Env.t}
  def rest_v10_vendors_get(connection, procore_company_id, company_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreRestV1APIDocumentation.Model.RestV10VendorsGet200ResponseInner{}]},
  ...
  - `{:ok, ProcoreRestV1APIDocumentation.Model.NormalViewBusinessRegister.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_vendors_id_business_register_patch(Tesla.Env.client, integer(), integer(), integer(), ProcoreRestV1APIDocumentation.Model.BusinessRegisterBody.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10WorkOrderContractsWorkOrderContractIdLineItemsSyncPatch200ResponseErrorsInnerAllOf1.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10WorkOrderContractsWorkOrderContractIdSubcontractorScheduleOfValuesStatusPatch404Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.NormalViewBusinessRegister.t} | {:error, Tesla.Env.t}
  def rest_v10_vendors_id_business_register_patch(connection, procore_company_id, id, company_id, business_register_body, _opts \\ []) do
    request =
      %{}
      |> method(:patch)
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %ProcoreRestV1APIDocumentation.Model.NormalViewBusinessRegister{}},
      {401, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {403, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      ...
      {422, %ProcoreRestV1APIDocumentation.Model.RestV10WorkOrderContractsWorkOrderContractIdLineItemsSyncPatch200ResponseErrorsInnerAllOf1{}}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_vendors_id_business_register_post(Tesla.Env.client, integer(), integer(), integer(), ProcoreRestV1APIDocumentation.Model.BusinessRegisterBody.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10WorkOrderContractsWorkOrderContractIdLineItemsSyncPatch200ResponseErrorsInnerAllOf1.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.NormalViewBusinessRegister.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10VendorsIdBusinessRegisterPost409Response.t} | {:error, Tesla.Env.t}
  def rest_v10_vendors_id_business_register_post(connection, procore_company_id, id, company_id, business_register_body, _opts \\ []) do
    request =
      %{}
      |> method(:post)
      |> url("/rest/v1.0/vendors/#{id}/business_register")
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {201, %ProcoreRestV1APIDocumentation.Model.NormalViewBusinessRegister{}},
      {400, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {401, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {403, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {409, %ProcoreRestV1APIDocumentation.Model.RestV10VendorsIdBusinessRegisterPost409Response{}},
      {422, %ProcoreRestV1APIDocumentation.Model.RestV10WorkOrderContractsWorkOrderContractIdLineItemsSyncPatch200ResponseErrorsInnerAllOf1{}}
    ])
  end
  ...
  - `{:ok, ProcoreRestV1APIDocumentation.Model.RestV10VendorsGet200ResponseInner.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_vendors_id_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10VendorsGet200ResponseInner.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_vendors_id_patch(Tesla.Env.client, integer(), integer(), ProcoreRestV1APIDocumentation.Model.CompanyVendorBody.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10VendorsGet200ResponseInner.t} | {:error, Tesla.Env.t}
  def rest_v10_vendors_id_patch(connection, procore_company_id, id, company_vendor_body, opts \\ []) do
    optional_params = %{
      :view => :query,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_vendors_post(Tesla.Env.client, integer(), ProcoreRestV1APIDocumentation.Model.CompanyVendorBody.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10VendorsGet200ResponseInner.t} | {:error, Tesla.Env.t}
  def rest_v10_vendors_post(connection, procore_company_id, company_vendor_body, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {201, %ProcoreRestV1APIDocumentation.Model.RestV10VendorsGet200ResponseInner{}},
      {400, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {401, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {403, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}}
    ])
  ...
  - `{:ok, ProcoreRestV1APIDocumentation.Model.RestV10VendorsSyncPatch200Response.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_vendors_sync_patch(Tesla.Env.client, integer(), ProcoreRestV1APIDocumentation.Model.CompanyVendorSyncBody.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10VendorsSyncPatch200Response.t} | {:error, Tesla.Env.t}
  def rest_v10_vendors_sync_patch(connection, procore_company_id, company_vendor_sync_body, opts \\ []) do
    optional_params = %{
      :run_configurable_validations => :query
    }
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %ProcoreRestV1APIDocumentation.Model.RestV10VendorsSyncPatch200Response{}},
      {400, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {401, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}},
      {403, %ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response{}}
    ])
