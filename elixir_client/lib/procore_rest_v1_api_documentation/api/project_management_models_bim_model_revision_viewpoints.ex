...
defmodule ProcoreRestV1APIDocumentation.Api.ProjectManagementModelsBIMModelRevisionViewpoints do
  @moduledoc """
  ...
  """
  @spec rest_v10_bim_model_revision_viewpoints_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, list(ProcoreRestV1APIDocumentation.Model.RestV10BimModelRevisionViewpointsGet200ResponseInner.t)} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_bim_model_revision_viewpoints_get(connection, procore_company_id, project_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%ProcoreRestV1APIDocumentation.Model.RestV10BimModelRevisionViewpointsGet200ResponseInner{}]},
