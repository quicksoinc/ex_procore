...
defmodule ProcoreRestV1APIDocumentation.Api.CoreProjectVendorProjectRoles do
  @moduledoc """
  ...
  - `{:ok, ProcoreRestV1APIDocumentation.Model.VendorProjectRole.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_projects_project_id_vendor_project_roles_id_patch(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.VendorProjectRole.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10WorkOrderContractsWorkOrderContractIdSubcontractorScheduleOfValuesStatusPatch404Response.t} | {:error, Tesla.Env.t}
  def rest_v10_projects_project_id_vendor_project_roles_id_patch(connection, procore_company_id, id, project_id, opts \\ []) do
    optional_params = %{
      :body => :body
    }
    ...
    |> evaluate_response([
      {200, %ProcoreRestV1APIDocumentation.Model.VendorProjectRole{}},
