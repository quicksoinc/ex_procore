...
defmodule ProcoreRestV1APIDocumentation.Api.ProjectManagementCoordinationIssuesCoordinationIssueExport do
  @moduledoc """
  ...
  """
  @spec rest_v10_coordination_issues_export_get(Tesla.Env.client, integer(), integer(), String.t, keyword()) :: {:ok, nil} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, String.t} | {:error, Tesla.Env.t}
  def rest_v10_coordination_issues_export_get(connection, procore_company_id, project_id, export_format, opts \\ []) do
    optional_params = %{
