...
defmodule ProcoreRestV1APIDocumentation.Api.ProjectManagementCoordinationIssuesCoordinationIssueAssignment do
  @moduledoc """
  ...
  - `{:ok, ProcoreRestV1APIDocumentation.Model.RestV10CoordinationIssuesCoordinationIssueIdAssignmentsPost201Response.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_coordination_issues_coordination_issue_id_assignments_post(Tesla.Env.client, integer(), integer(), ProcoreRestV1APIDocumentation.Model.RestV10CoordinationIssuesCoordinationIssueIdAssignmentsPostRequest.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CoordinationIssuesCoordinationIssueIdAssignmentsPost201Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
  def rest_v10_coordination_issues_coordination_issue_id_assignments_post(connection, procore_company_id, coordination_issue_id, rest_v10_coordination_issues_coordination_issue_id_assignments_post_request, _opts \\ []) do
    ...
    |> evaluate_response([
      {201, %ProcoreRestV1APIDocumentation.Model.RestV10CoordinationIssuesCoordinationIssueIdAssignmentsPost201Response{}},
