...
defmodule ProcoreRestV1APIDocumentation.Api.ConstructionFinancialsBudgetBudgetViewDetailRows do
  @moduledoc """
  ...
  """
  @spec rest_v10_budget_views_budget_view_id_detail_rows_get(Tesla.Env.client, integer(), integer(), integer(), keyword()) :: {:ok, list(ProcoreRestV1APIDocumentation.Model.RestV10BudgetViewSnapshotsBudgetViewSnapshotIdDetailRowsGet200ResponseInner.t)} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:error, Tesla.Env.t}
