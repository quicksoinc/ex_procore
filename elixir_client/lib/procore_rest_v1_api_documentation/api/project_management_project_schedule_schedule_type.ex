...
defmodule ProcoreRestV1APIDocumentation.Api.ProjectManagementProjectScheduleScheduleType do
  @moduledoc """
  ...
  - `{:ok, ProcoreRestV1APIDocumentation.Model.RestV10ScheduleTypeGet200Response.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_schedule_type_get(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10ScheduleTypeGet200Response.t} | {:error, Tesla.Env.t}
  def rest_v10_schedule_type_get(connection, procore_company_id, project_id, _opts \\ []) do
    ...
    |> evaluate_response([
      {200, %ProcoreRestV1APIDocumentation.Model.RestV10ScheduleTypeGet200Response{}},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec rest_v10_schedule_type_patch(Tesla.Env.client, integer(), ProcoreRestV1APIDocumentation.Model.Body16.t, keyword()) :: {:ok, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response.t} | {:ok, ProcoreRestV1APIDocumentation.Model.RestV10ScheduleTypeGet200Response.t} | {:error, Tesla.Env.t}
