...
defmodule ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdBidPackagesGet200ResponseBidPackagesInner do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :links => ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdBidPackagesGet200ResponseBidPackagesInnerLinks.t | nil,
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdBidPackagesGet200ResponseBidPackagesInner do
  import ProcoreRestV1APIDocumentation.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:links, :struct, ProcoreRestV1APIDocumentation.Model.RestV10CompaniesCompanyIdBidPackagesGet200ResponseBidPackagesInnerLinks, options)
  end
end
