...
defmodule ProcoreRestV1APIDocumentation.Model.InspectionUser do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :custom_fields => ProcoreRestV1APIDocumentation.Model.InspectionUserCustomFields.t | nil
  }
end

defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.InspectionUser do
  import ProcoreRestV1APIDocumentation.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:vendor, :struct, ProcoreRestV1APIDocumentation.Model.NameView, options)
    |> deserialize(:custom_fields, :struct, ProcoreRestV1APIDocumentation.Model.InspectionUserCustomFields, options)
  end
end
