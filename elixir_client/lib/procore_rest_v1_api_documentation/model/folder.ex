...
defmodule ProcoreRestV1APIDocumentation.Model.Folder do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :folders => [ProcoreRestV1APIDocumentation.Model.Folder.t] | nil,
    :files => [ProcoreRestV1APIDocumentation.Model.FolderFilesInner.t] | nil,
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.Folder do
  import ProcoreRestV1APIDocumentation.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:folders, :list, ProcoreRestV1APIDocumentation.Model.Folder, options)
    |> deserialize(:files, :list, ProcoreRestV1APIDocumentation.Model.FolderFilesInner, options)
