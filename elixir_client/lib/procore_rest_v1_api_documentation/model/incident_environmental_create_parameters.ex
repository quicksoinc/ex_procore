...
defmodule ProcoreRestV1APIDocumentation.Model.IncidentEnvironmentalCreateParameters do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.IncidentEnvironmentalCreateParameters do
