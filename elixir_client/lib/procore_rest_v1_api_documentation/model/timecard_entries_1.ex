...
defmodule ProcoreRestV1APIDocumentation.Model.TimecardEntries1 do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :updates => [ProcoreRestV1APIDocumentation.Model.TimecardEntries1UpdatesInner.t],
    :user_id => integer() | nil,
    :work_classification_id => integer() | nil
  }
end

defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.TimecardEntries1 do
  import ProcoreRestV1APIDocumentation.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:date, :date, nil, options)
    |> deserialize(:updates, :list, ProcoreRestV1APIDocumentation.Model.TimecardEntries1UpdatesInner, options)
  end
end
