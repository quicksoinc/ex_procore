...
defmodule ProcoreRestV1APIDocumentation.Model.GenericToolItem1CreatedBy do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.GenericToolItem1CreatedBy do
