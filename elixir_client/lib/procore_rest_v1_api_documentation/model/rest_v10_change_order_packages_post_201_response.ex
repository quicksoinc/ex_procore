...
defmodule ProcoreRestV1APIDocumentation.Model.RestV10ChangeOrderPackagesPost201Response do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :line_items => [ProcoreRestV1APIDocumentation.Model.RestV10ChangeOrderPackagesPost201ResponseLineItemsInner.t] | nil,
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.RestV10ChangeOrderPackagesPost201Response do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:line_items, :list, ProcoreRestV1APIDocumentation.Model.RestV10ChangeOrderPackagesPost201ResponseLineItemsInner, options)
