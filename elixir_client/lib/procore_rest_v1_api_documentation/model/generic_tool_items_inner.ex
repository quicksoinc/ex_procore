...
defmodule ProcoreRestV1APIDocumentation.Model.GenericToolItemsInner do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.GenericToolItemsInner do
