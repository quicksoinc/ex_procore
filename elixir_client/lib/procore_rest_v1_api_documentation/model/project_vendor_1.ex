...
defmodule ProcoreRestV1APIDocumentation.Model.ProjectVendor1 do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :zip => String.t | nil,
    :bidding => ProcoreRestV1APIDocumentation.Model.ProjectVendor1Bidding.t | nil
  }
end

defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.ProjectVendor1 do
  import ProcoreRestV1APIDocumentation.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:bidding, :struct, ProcoreRestV1APIDocumentation.Model.ProjectVendor1Bidding, options)
  end
end
