...
defmodule ProcoreRestV1APIDocumentation.Model.Project3 do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :code => String.t | nil,
    :persistent_message => ProcoreRestV1APIDocumentation.Model.ProjectPersistentMessage1.t | nil,
    :office => ProcoreRestV1APIDocumentation.Model.ProjectOffice1.t | nil,
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.Project3 do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:persistent_message, :struct, ProcoreRestV1APIDocumentation.Model.ProjectPersistentMessage1, options)
    |> deserialize(:office, :struct, ProcoreRestV1APIDocumentation.Model.ProjectOffice1, options)
