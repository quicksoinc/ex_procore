...
defmodule ProcoreRestV1APIDocumentation.Model.PaymentApplicationOwnerInvoice1 do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.PaymentApplicationOwnerInvoice1 do
