...
defmodule ProcoreRestV1APIDocumentation.Model.PdfTemplateConfigPdfConfigOptions do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.PdfTemplateConfigPdfConfigOptions do
