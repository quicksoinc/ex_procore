...
defmodule ProcoreRestV1APIDocumentation.Model.IncidentWitnessStatementUpdateParameters1 do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.IncidentWitnessStatementUpdateParameters1 do
