...
defmodule ProcoreRestV1APIDocumentation.Model.TimecardEntry1 do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :timesheet_status => ProcoreRestV1APIDocumentation.Model.Timesheet1.t | nil,
    ...
    :timecard_time_type => ProcoreRestV1APIDocumentation.Model.TimecardTimeType3.t | nil,
    :line_item_type_id => integer() | nil
  }
end

defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.TimecardEntry1 do
  import ProcoreRestV1APIDocumentation.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:date, :date, nil, options)
    |> deserialize(:timesheet_status, :struct, ProcoreRestV1APIDocumentation.Model.Timesheet1, options)
    ...
    |> deserialize(:timecard_time_type, :struct, ProcoreRestV1APIDocumentation.Model.TimecardTimeType3, options)
  end
end
