...
defmodule ProcoreRestV1APIDocumentation.Model.RfiBodyRfi do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :question => ProcoreRestV1APIDocumentation.Model.RfiBodyRfiQuestion.t,
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.RfiBodyRfi do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:question, :struct, ProcoreRestV1APIDocumentation.Model.RfiBodyRfiQuestion, options)
