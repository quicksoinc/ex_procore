...
defmodule ProcoreRestV1APIDocumentation.Model.CompanyVendorBidding do
  @moduledoc """
  Bidding statuses
  """
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.CompanyVendorBidding do
