...
defmodule ProcoreRestV1APIDocumentation.Model.DrawingUpload do
  @moduledoc """
  Drawing Upload
  """
  ...
  @type t :: %__MODULE__{
    ...
    :drawing_log_imports => [ProcoreRestV1APIDocumentation.Model.DrawingLogImport.t] | nil
  }
end

defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.DrawingUpload do
  import ProcoreRestV1APIDocumentation.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:drawing_log_imports, :list, ProcoreRestV1APIDocumentation.Model.DrawingLogImport, options)
  end
end
