...
defmodule ProcoreRestV1APIDocumentation.Model.Checklist do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :specification_section => ProcoreRestV1APIDocumentation.Model.ChecklistSpecificationSection.t | nil,
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.Checklist do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:specification_section, :struct, ProcoreRestV1APIDocumentation.Model.ChecklistSpecificationSection, options)
