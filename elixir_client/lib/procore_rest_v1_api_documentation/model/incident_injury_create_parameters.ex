...
defmodule ProcoreRestV1APIDocumentation.Model.IncidentInjuryCreateParameters do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.IncidentInjuryCreateParameters do
