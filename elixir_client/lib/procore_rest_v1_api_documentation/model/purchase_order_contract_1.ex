...
defmodule ProcoreRestV1APIDocumentation.Model.PurchaseOrderContract1 do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.PurchaseOrderContract1 do
