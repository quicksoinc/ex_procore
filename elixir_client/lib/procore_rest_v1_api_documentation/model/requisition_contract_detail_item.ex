...
defmodule ProcoreRestV1APIDocumentation.Model.RequisitionContractDetailItem do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.RequisitionContractDetailItem do
