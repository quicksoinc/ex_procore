...
defmodule ProcoreRestV1APIDocumentation.Model.RestV10PrimeContractGet200Response do
  @moduledoc """
  Prime Contract
  """
  ...
  @type t :: %__MODULE__{
    ...
    :change_order_packages => [ProcoreRestV1APIDocumentation.Model.RestV10WorkOrderContractsPost201ResponseChangeOrderPackagesInner.t] | nil,
    ...
    :potential_change_orders => [ProcoreRestV1APIDocumentation.Model.RestV10WorkOrderContractsPost201ResponsePotentialChangeOrdersInner.t] | nil,
    :payments_received => [ProcoreRestV1APIDocumentation.Model.RestV10WorkOrderContractsPost201ResponsePaymentsIssuedInner.t] | nil,
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.RestV10PrimeContractGet200Response do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:change_order_packages, :list, ProcoreRestV1APIDocumentation.Model.RestV10WorkOrderContractsPost201ResponseChangeOrderPackagesInner, options)
    ...
    |> deserialize(:potential_change_orders, :list, ProcoreRestV1APIDocumentation.Model.RestV10WorkOrderContractsPost201ResponsePotentialChangeOrdersInner, options)
    |> deserialize(:payments_received, :list, ProcoreRestV1APIDocumentation.Model.RestV10WorkOrderContractsPost201ResponsePaymentsIssuedInner, options)
