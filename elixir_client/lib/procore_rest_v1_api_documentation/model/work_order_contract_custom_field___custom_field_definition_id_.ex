...
defmodule ProcoreRestV1APIDocumentation.Model.WorkOrderContractCustomFieldCustomFieldDefinitionId do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.WorkOrderContractCustomFieldCustomFieldDefinitionId do
