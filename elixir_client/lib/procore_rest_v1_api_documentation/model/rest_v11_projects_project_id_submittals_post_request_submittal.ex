...
defmodule ProcoreRestV1APIDocumentation.Model.RestV11ProjectsProjectIdSubmittalsPostRequestSubmittal do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :title => String.t | nil,
    :type => String.t | nil,
    :workflow_data => [[ProcoreRestV1APIDocumentation.Model.RestV11ProjectsProjectIdSubmittalsPostRequestSubmittalWorkflowDataInnerInner.t]] | nil,
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.RestV11ProjectsProjectIdSubmittalsPostRequestSubmittal do
