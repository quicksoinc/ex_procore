...
defmodule ProcoreRestV1APIDocumentation.Model.Rfq do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :change_event => ProcoreRestV1APIDocumentation.Model.RfqChangeEvent.t | nil,
    :currency_configuration => ProcoreRestV1APIDocumentation.Model.RfqCurrencyConfiguration.t | nil
  }
end

defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.Rfq do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:change_event, :struct, ProcoreRestV1APIDocumentation.Model.RfqChangeEvent, options)
