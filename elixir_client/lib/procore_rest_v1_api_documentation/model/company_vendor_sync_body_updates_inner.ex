...
defmodule ProcoreRestV1APIDocumentation.Model.CompanyVendorSyncBodyUpdatesInner do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :bidding => ProcoreRestV1APIDocumentation.Model.CompanyVendorSyncBodyUpdatesInnerBidding.t | nil
  }
end

defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.CompanyVendorSyncBodyUpdatesInner do
  import ProcoreRestV1APIDocumentation.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:bidding, :struct, ProcoreRestV1APIDocumentation.Model.CompanyVendorSyncBodyUpdatesInnerBidding, options)
  end
end
