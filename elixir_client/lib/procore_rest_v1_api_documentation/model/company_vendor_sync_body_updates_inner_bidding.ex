...
defmodule ProcoreRestV1APIDocumentation.Model.CompanyVendorSyncBodyUpdatesInnerBidding do
  @moduledoc """
  Bidding statuses
  """
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.CompanyVendorSyncBodyUpdatesInnerBidding do
