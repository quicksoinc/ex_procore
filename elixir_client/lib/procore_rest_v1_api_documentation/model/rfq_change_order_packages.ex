...
defmodule ProcoreRestV1APIDocumentation.Model.RfqChangeOrderPackages do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.RfqChangeOrderPackages do
