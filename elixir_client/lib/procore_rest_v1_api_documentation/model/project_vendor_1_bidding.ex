...
defmodule ProcoreRestV1APIDocumentation.Model.ProjectVendor1Bidding do
  @moduledoc """
  Bidding statuses
  """
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.ProjectVendor1Bidding do
