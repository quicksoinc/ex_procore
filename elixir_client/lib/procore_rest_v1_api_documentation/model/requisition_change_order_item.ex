...
defmodule ProcoreRestV1APIDocumentation.Model.RequisitionChangeOrderItem do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.RequisitionChangeOrderItem do
