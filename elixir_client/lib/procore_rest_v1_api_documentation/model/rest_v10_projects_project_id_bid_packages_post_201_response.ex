...
defmodule ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdBidPackagesPost201Response do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :created_by => ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdBidPackagesPost201ResponseCreatedBy.t | nil,
    :number => integer() | nil,
    :title => String.t | nil,
    :project_name => String.t | nil,
    :project_location => String.t | nil,
    :accounting_method => String.t | nil,
    :bid_docs_manifest => ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdBidPackagesPost201ResponseBidDocsManifest.t | nil,
    :bid_email_message => String.t | nil,
    :bid_web_message => String.t | nil,
    :bid_submission_confirmation => String.t | nil,
    :point_of_contact => ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdBidPackagesPost201ResponsePointOfContact.t | nil,
    ...
    :links => ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdBidPackagesPost201ResponseLinks.t | nil
  }
end

defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdBidPackagesPost201Response do
  import ProcoreRestV1APIDocumentation.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:created_by, :struct, ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdBidPackagesPost201ResponseCreatedBy, options)
    |> deserialize(:bid_docs_manifest, :struct, ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdBidPackagesPost201ResponseBidDocsManifest, options)
    |> deserialize(:point_of_contact, :struct, ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdBidPackagesPost201ResponsePointOfContact, options)
    |> deserialize(:anticipated_award_date, :date, nil, options)
    |> deserialize(:links, :struct, ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdBidPackagesPost201ResponseLinks, options)
  end
end
