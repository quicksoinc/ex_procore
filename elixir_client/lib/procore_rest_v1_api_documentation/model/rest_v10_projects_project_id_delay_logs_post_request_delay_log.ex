...
defmodule ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdDelayLogsPostRequestDelayLog do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdDelayLogsPostRequestDelayLog do
