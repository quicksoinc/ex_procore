...
defmodule ProcoreRestV1APIDocumentation.Model.Body131BimGeometryFileBundle do
  @moduledoc """
  BIM Geometry File
  """
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.Body131BimGeometryFileBundle do
