...
defmodule ProcoreRestV1APIDocumentation.Model.IncidentNormalAllOfNearMissesInnerAllOf do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.IncidentNormalAllOfNearMissesInnerAllOf do
