...
defmodule ProcoreRestV1APIDocumentation.Model.PunchItem do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :assignments => [ProcoreRestV1APIDocumentation.Model.PunchItemAssignmentsInner.t] | nil,
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.PunchItem do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:assignments, :list, ProcoreRestV1APIDocumentation.Model.PunchItemAssignmentsInner, options)
