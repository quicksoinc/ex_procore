...
defmodule ProcoreRestV1APIDocumentation.Model.PaymentApplicationOwnerInvoiceLineItem do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.PaymentApplicationOwnerInvoiceLineItem do
