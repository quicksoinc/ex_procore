...
defmodule ProcoreRestV1APIDocumentation.Model.PurchaseOrderContract do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.PurchaseOrderContract do
