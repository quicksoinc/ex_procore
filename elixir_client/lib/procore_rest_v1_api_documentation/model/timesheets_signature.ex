...
defmodule ProcoreRestV1APIDocumentation.Model.TimesheetsSignature do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.TimesheetsSignature do
