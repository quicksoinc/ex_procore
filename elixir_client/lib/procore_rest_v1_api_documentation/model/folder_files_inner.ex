...
defmodule ProcoreRestV1APIDocumentation.Model.FolderFilesInner do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :file_versions => [ProcoreRestV1APIDocumentation.Model.FolderFilesInnerFileVersionsInner.t] | nil,
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.FolderFilesInner do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:file_versions, :list, ProcoreRestV1APIDocumentation.Model.FolderFilesInnerFileVersionsInner, options)
