...
defmodule ProcoreRestV1APIDocumentation.Model.IncidentEnvironmentalUpdateParameters do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.IncidentEnvironmentalUpdateParameters do
