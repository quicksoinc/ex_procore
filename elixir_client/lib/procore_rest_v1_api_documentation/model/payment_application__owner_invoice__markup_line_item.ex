...
defmodule ProcoreRestV1APIDocumentation.Model.PaymentApplicationOwnerInvoiceMarkupLineItem do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.PaymentApplicationOwnerInvoiceMarkupLineItem do
