...
defmodule ProcoreRestV1APIDocumentation.Model.TimesheetEntries1 do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :timecard_time_type => ProcoreRestV1APIDocumentation.Model.TimecardTimeType2.t | nil
  }
end

defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.TimesheetEntries1 do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:timecard_time_type, :struct, ProcoreRestV1APIDocumentation.Model.TimecardTimeType2, options)
  end
end
