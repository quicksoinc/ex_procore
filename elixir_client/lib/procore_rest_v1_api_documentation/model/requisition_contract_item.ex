...
defmodule ProcoreRestV1APIDocumentation.Model.RequisitionContractItem do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.RequisitionContractItem do
