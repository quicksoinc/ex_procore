...
defmodule ProcoreRestV1APIDocumentation.Model.CompanyUser do
  @moduledoc """
  Company User
  """
  ...
  @type t :: %__MODULE__{
    ...
    :permission_template => ProcoreRestV1APIDocumentation.Model.CompanyUserPermissionTemplate.t | nil,
    :company_permission_template => ProcoreRestV1APIDocumentation.Model.CompanyUserPermissionTemplate.t | nil,
    :vendor => ProcoreRestV1APIDocumentation.Model.RestV10ProjectsProjectIdPunchItemAssignmentsIdGet200ResponseVendor.t | nil
  }
end

defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.CompanyUser do
  import ProcoreRestV1APIDocumentation.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:permission_template, :struct, ProcoreRestV1APIDocumentation.Model.CompanyUserPermissionTemplate, options)
    |> deserialize(:company_permission_template, :struct, ProcoreRestV1APIDocumentation.Model.CompanyUserPermissionTemplate, options)
