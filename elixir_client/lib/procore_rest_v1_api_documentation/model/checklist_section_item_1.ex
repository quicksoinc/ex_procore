...
defmodule ProcoreRestV1APIDocumentation.Model.ChecklistSectionItem1 do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :observations => [ProcoreRestV1APIDocumentation.Model.ChecklistSectionItem1ObservationsInner.t] | nil,
    :attachment_histories => [ProcoreRestV1APIDocumentation.Model.ChecklistSectionItem1AttachmentHistoriesInner.t] | nil,
    :attachments => [ProcoreRestV1APIDocumentation.Model.ChecklistSectionItem1AttachmentsInner.t] | nil,
    ...
    :response_set => ProcoreRestV1APIDocumentation.Model.ChecklistSectionItem1ResponseSet.t | nil,
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.ChecklistSectionItem1 do
  import ProcoreRestV1APIDocumentation.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:observations, :list, ProcoreRestV1APIDocumentation.Model.ChecklistSectionItem1ObservationsInner, options)
    |> deserialize(:attachment_histories, :list, ProcoreRestV1APIDocumentation.Model.ChecklistSectionItem1AttachmentHistoriesInner, options)
    |> deserialize(:attachments, :list, ProcoreRestV1APIDocumentation.Model.ChecklistSectionItem1AttachmentsInner, options)
    ...
    |> deserialize(:response_set, :struct, ProcoreRestV1APIDocumentation.Model.ChecklistSectionItem1ResponseSet, options)
