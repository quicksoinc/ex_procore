...
defmodule ProcoreRestV1APIDocumentation.Model.RfiBodyRfiQuestion do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.RfiBodyRfiQuestion do
