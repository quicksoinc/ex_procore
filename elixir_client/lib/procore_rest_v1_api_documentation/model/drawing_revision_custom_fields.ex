...
defmodule ProcoreRestV1APIDocumentation.Model.DrawingRevisionCustomFields do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.DrawingRevisionCustomFields do
