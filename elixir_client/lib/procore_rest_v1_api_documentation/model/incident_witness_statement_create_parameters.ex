...
defmodule ProcoreRestV1APIDocumentation.Model.IncidentWitnessStatementCreateParameters do
  @moduledoc """
...
defimpl Poison.Decoder, for: ProcoreRestV1APIDocumentation.Model.IncidentWitnessStatementCreateParameters do
