...
defmodule ProcoreRestV1APIDocumentation.Connection do
  @moduledoc """
  Handle Tesla connections for ProcoreRestV1APIDocumentation.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, ProcoreRestV1APIDocumentation.Connection,
        base_url: "https://api.procore.com",
        adapter: Tesla.Adapter.Hackney

  The default base URL can also be set as:

      config :procore_rest_v1_api_documentation,
        :base_url, "https://api.procore.com"
  """

  @default_base_url Application.compile_env(
                      :procore_rest_v1_api_documentation,
                      :base_url,
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:procore_rest_v1_api_documentation, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - ProcoreRestV1APIDocumentation 1.0 - elixir"
        )
      )
